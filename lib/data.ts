...
export const courses: Course[] = [
  ...
  },
  {
    ...
    title: "Anatomy & Physiology for Interpreters",
    category: "Medical",
    track: "cchi",
    level: "Beginner",
    description:
      "Functional anatomy and physiology across the major body systems, framed for the explanations providers give so interpreters can render clinical meaning accurately.",
    instructor: "Sofia Marin",
    lessonsCount: 6,
    hours: 6,
    enrolled: 840,
  ...
  },
  {
    ...
    level: "Intermediate",
    description:
      "Camera presence, platform tools, and positioning for effective video remote interpreting in clinical settings.",
    instructor: "Daniel Okoro",
    lessonsCount: 5,
    hours: 5,
    enrolled: 690,
  ...
  },
  {
    ...
    level: "Intermediate",
    description:
      "How faithful interpreting prevents medical error — read-backs, clarification, and recognizing high-risk moments in the encounter.",
    instructor: "Sofia Marin",
    lessonsCount: 5,
    hours: 5,
    enrolled: 640,
