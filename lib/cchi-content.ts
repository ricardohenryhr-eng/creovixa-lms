...
// ─────────────────────────────────────────────────────────────────────────
// 15. Obstetrics & Gynecology Interpreting
// ─────────────────────────────────────────────────────────────────────────
cchiContent["obstetrics-gynecology-interpreting"] = {
  resources: res("COGI"),
  modules: [
    {
      id: "m1",
      ...
      lessons: [
        {
          ...
          videoUrl: V.a,
          objectives: [
            "Understand how pregnancy is described and tracked",
            "Recognize core pregnancy vocabulary in both languages",
            "Interpret pregnancy history and dating information precisely",
          ],
          content: [
            "Obstetrics is the branch of medicine that cares for pregnancy, childbirth, and the period immediately after. Pregnancy is described with a precise vocabulary the interpreter must know instantly: gestation (the length of pregnancy, counted in weeks), the three trimesters, the estimated due date (EDD), and the standard obstetric history summarized as gravida (number of pregnancies) and para (number of births). Clinicians also use terms like last menstrual period (LMP) to date a pregnancy. Rendering these terms and numbers exactly is essential, because they define how far along a pregnancy is and what care is appropriate.",
            "Much of an obstetric encounter centers on history and dating, and small numeric details carry real weight. The interpreter conveys the exact number of weeks of gestation, prior pregnancy outcomes, and any complications precisely, because a patient at 8 weeks and a patient at 38 weeks are in entirely different clinical situations. Symptoms of early pregnancy — nausea, fatigue, breast tenderness — and the patient's own descriptions are rendered faithfully in the register the patient used.",
            "Pregnancy is also emotionally significant and often culturally shaped, and the interpreter conveys that meaning without altering it. Worked example: a patient reports, 'my last period started around March 3rd, and this is my third pregnancy but I had one miscarriage'; the interpreter renders the LMP date and the full obstetric history exactly — three pregnancies, one loss — because the clinician uses these details to date the pregnancy and to understand the patient's risk, and any dropped or blurred detail changes that assessment.",
          ],
          terminology: [
            { term: "Gestation", definition: "The length of a pregnancy, counted in weeks." },
            { term: "Trimester", definition: "One of the three roughly three-month stages of pregnancy." },
            { term: "Gravida / para", definition: "The number of a woman's pregnancies / the number of births." },
            { term: "LMP", definition: "Last menstrual period, used to estimate the due date." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When a patient states her LMP date and prior pregnancy history, the interpreter should:",
              options: ["Approximate the dates", "Render the dates and history exactly", "Summarize the history", "Skip the miscarriage"],
              answer: 1,
            },
          ],
        },
        {
          ...
          objectives: [
            ...
            "Recognize prenatal screening and test vocabulary",
            "Interpret results and instructions accurately and completely",
          ],
          content: [
            "Prenatal care is the ongoing series of visits that monitor the health of the pregnant patient and the developing baby. It includes routine checks (weight, blood pressure, measuring the growing uterus, listening to the fetal heartbeat), laboratory tests, and screening for conditions like gestational diabetes and preeclampsia. The interpreter encounters this vocabulary repeatedly — ultrasound, fetal heart rate, fundal height, glucose screening — and renders each term and each measurement precisely so the patient understands how the pregnancy is progressing.",
            "Prenatal visits are dense with screening and results, and clinicians explain what tests are for and what the numbers mean. Blood pressure readings, blood-sugar values, blood type and Rh status, and ultrasound findings all must be conveyed exactly, along with the clinician's interpretation. The interpreter also carries the patient's questions and symptoms faithfully — swelling, headaches, decreased fetal movement — some of which are important warning signs that must never be minimized.",
            "Warning signs in pregnancy are safety-critical, and the interpreter renders them with their full urgency. Worked example: a clinician instructs, 'if you get a bad headache, see spots in your vision, or notice sudden swelling in your face and hands, call us or come in right away — those can be signs of preeclampsia'; the interpreter conveys each specific warning sign and the instruction to seek care immediately, completely and precisely, because these symptoms can signal a dangerous condition and the patient's timely response depends on understanding them.",
          ],
          terminology: [
            { term: "Prenatal care", definition: "Ongoing medical care during pregnancy to monitor mother and baby." },
            { term: "Ultrasound", definition: "An imaging scan using sound waves to view the fetus." },
            { term: "Fundal height", definition: "A measurement of the uterus used to track fetal growth." },
            { term: "Preeclampsia", definition: "A pregnancy complication marked by high blood pressure and warning signs." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "Warning-sign instructions like severe headache or vision changes should be:",
              options: ["Softened to avoid worry", "Rendered completely and precisely, with their urgency", "Summarized", "Omitted"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Understand the stages of labor and delivery vocabulary",
            "Interpret rapidly and accurately during an intense, dynamic event",
            "Convey pain, consent, and instructions faithfully during birth",
          ],
          content: [
            "Labor and delivery is the process of childbirth, and it has both a specialized vocabulary and a fast, emotionally intense pace. Key terms include contractions, dilation and effacement of the cervix, the stages of labor, rupture of membranes ('water breaking'), fetal monitoring, pushing, and modes of delivery — vaginal birth, assisted delivery, and cesarean section (C-section). The interpreter must know these instantly and render them accurately, because instructions and decisions during labor are often time-sensitive.",
            "During labor the interpreter conveys a continuous stream of communication: the patient's reports of pain and contractions, the team's coaching ('breathe,' 'push now,' 'stop pushing'), progress updates on dilation, and pain-management options like epidural anesthesia. Each is rendered faithfully and promptly, matching the urgency and coaching tone the provider uses, so the laboring patient can follow instructions in real time. Numbers — centimeters of dilation, fetal heart rate — are conveyed exactly.",
            "Labor also involves consent and rapid decisions, sometimes emergent, which the interpreter renders completely. Worked example: fetal monitoring shows a concerning pattern and the obstetrician says, 'the baby's heart rate is dropping and we need to do a C-section right away — do you consent?'; the interpreter conveys the situation, the recommendation, and the request for consent immediately and precisely, so the patient can understand and respond in a moment where delay carries real risk, while the interpreter stays strictly in the language role.",
          ],
          terminology: [
            { term: "Contraction", definition: "A tightening of the uterus that helps push the baby out during labor." },
            { term: "Dilation / effacement", definition: "The opening / thinning of the cervix during labor." },
            { term: "Cesarean section", definition: "Surgical delivery of the baby through the abdomen (C-section)." },
            { term: "Epidural", definition: "Regional anesthesia commonly used for pain relief in labor." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When an urgent C-section is recommended and consent requested, the interpreter should:",
              options: ["Explain the surgery themselves", "Render the situation, recommendation, and consent request immediately and precisely", "Reassure the patient", "Decide for the patient"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Describe the postpartum period and its common concerns",
            "Recognize postpartum vocabulary, including mental health",
            "Interpret recovery instructions and warning signs faithfully",
          ],
          content: [
            "The postpartum period is the time after childbirth as the body recovers, typically the first six weeks but extending beyond. Care covers physical recovery (uterine involution, bleeding known as lochia, healing of any tears or a C-section incision), breastfeeding support and lactation, newborn care guidance, and screening for postpartum complications. The interpreter renders this vocabulary and the associated instructions precisely so a recovering patient knows what is normal and what is not.",
            "Postpartum encounters combine physical and emotional health, and both are conveyed faithfully. The interpreter carries recovery instructions — activity limits, incision care, breastfeeding guidance — completely, along with the patient's questions and symptoms. Mental health is a central part of postpartum care: providers screen for postpartum depression and anxiety, and the interpreter renders these screening questions and the patient's answers exactly, without softening emotional disclosures.",
            "Postpartum warning signs, physical and emotional, are safety-critical. Worked example: a patient says, 'the bleeding suddenly got much heavier and I'm soaking a pad every hour, and honestly I've been crying all the time and feel like I can't care for the baby'; the interpreter renders both the physical warning sign (heavy bleeding) and the emotional distress precisely and completely, because each can signal a serious postpartum complication — hemorrhage or postpartum depression — and the clinician's response depends on hearing them fully.",
          ],
          terminology: [
            { term: "Postpartum", definition: "The period after childbirth as the body recovers." },
            { term: "Lochia", definition: "Normal vaginal bleeding and discharge after delivery." },
            { term: "Lactation", definition: "The production of breast milk and the support around breastfeeding." },
            { term: "Postpartum depression", definition: "A mood disorder after childbirth, screened for in postpartum care." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "A postpartum patient's emotional disclosure of persistent crying should be:",
              options: ["Softened", "Rendered precisely, as it can signal postpartum depression", "Omitted", "Treated as unimportant"],
              answer: 1,
            },
          ],
        },
      ...
      lessons: [
        {
          ...
          videoUrl: V.b,
          objectives: [
            "Understand the scope of gynecologic care",
            "Recognize core women's-health vocabulary",
            "Interpret sensitive history with accuracy and neutrality",
          ],
          content: [
            "Gynecology is the branch of medicine focused on the female reproductive system outside of pregnancy. Women's-health encounters address the menstrual cycle, pelvic and abdominal symptoms, the reproductive organs (uterus, ovaries, cervix, vagina), and life stages such as puberty, the reproductive years, and menopause. The interpreter must be fluent in this vocabulary in both languages and comfortable rendering it accurately, since much of the history is personal and specific.",
            "Gynecologic history is often sensitive — menstrual patterns, sexual history, pain, and bleeding — and the interpreter's role is faithful, neutral rendering without embarrassment or editing. Terms like menstruation, dysmenorrhea (painful periods), abnormal bleeding, pelvic pain, and menopause recur frequently, and the patient's own descriptions of these experiences are conveyed exactly. Precision about timing, amount, and character of symptoms is clinically important.",
            "Because these topics are intimate, the interpreter maintains professionalism and preserves the patient's dignity while rendering everything faithfully. Worked example: a patient describes, in frank terms, heavy and painful periods and pain during intercourse; the interpreter conveys each symptom completely and accurately, in the register the patient used, without softening, censoring, or adding comfort — so the clinician receives the true clinical picture and the patient's account is respected exactly as given.",
          ],
          terminology: [
            { term: "Gynecology", definition: "Medical care of the female reproductive system outside of pregnancy." },
            { term: "Menstruation", definition: "The monthly shedding of the uterine lining (the menstrual period)." },
            { term: "Dysmenorrhea", definition: "Painful menstrual periods." },
            { term: "Menopause", definition: "The natural end of menstrual cycles, marking the end of reproductive years." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When a patient frankly describes intimate gynecologic symptoms, the interpreter should:",
              options: ["Soften or censor the language", "Render everything faithfully in the patient's register", "Add reassurance", "Summarize to avoid discomfort"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Recognize reproductive-health topics and vocabulary",
            "Interpret contraception and fertility discussions accurately",
            "Convey sensitive family-planning choices neutrally and completely",
          ],
          content: [
            "Reproductive health covers contraception, family planning, fertility and infertility, sexually transmitted infections (STIs), and related counseling. Vocabulary includes the many contraceptive methods (oral contraceptives, IUD, implant, injection, barrier methods, sterilization), fertility terms (ovulation, conception, infertility, assisted reproduction), and STI screening and treatment. The interpreter renders method names, instructions, and options precisely, because these choices have significant personal and medical consequences.",
            "Family-planning and fertility conversations involve detailed counseling that the interpreter conveys completely: how a method works, how to use it, its effectiveness, side effects, and alternatives. STI discussions require both accuracy and sensitivity, including screening questions, results, treatment, and partner notification. Throughout, the interpreter renders the patient's questions, preferences, and concerns faithfully, so the patient can make an informed decision aligned with their own values.",
            "These topics can carry cultural, religious, and emotional weight, and the interpreter stays neutral while rendering fully. Worked example: a patient says her beliefs shape which contraceptive options she will consider, and asks the clinician about alternatives; the interpreter conveys the patient's stated values and question completely and neutrally, and renders the clinician's counseling faithfully, without inserting the interpreter's own opinion or steering the choice — keeping the decision entirely between patient and provider.",
          ],
          terminology: [
            { term: "Contraception", definition: "Methods used to prevent pregnancy." },
            { term: "IUD", definition: "An intrauterine device, a long-acting contraceptive placed in the uterus." },
            { term: "Fertility / infertility", definition: "The ability / reduced ability to conceive a pregnancy." },
            { term: "STI", definition: "A sexually transmitted infection." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When a patient's beliefs shape her contraceptive choices, the interpreter should:",
              options: ["Advise her on the best method", "Render her values and questions completely and neutrally", "Skip the beliefs", "Persuade her"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Recognize gynecologic preventive screenings and their vocabulary",
            "Interpret screening instructions and results precisely",
            "Convey the purpose of prevention so patients follow through",
          ],
          content: [
            "Preventive care in gynecology aims to detect problems early, before symptoms appear. Core screenings include the Pap smear (cervical cancer screening), HPV testing, the clinical breast exam and mammogram (breast cancer screening), pelvic exams, and bone-density testing after menopause. The interpreter renders the names of these screenings, the instructions around them, and their results precisely, because prevention only works when the patient understands what is recommended and why.",
            "Preventive visits involve explaining recommendations tied to age and risk, describing what a screening involves, and communicating results and any needed follow-up. The interpreter conveys screening intervals ('a Pap every three years'), abnormal-result explanations, and next steps completely and exactly, since a misunderstood result or interval can lead to a missed cancer or unnecessary alarm. Patient questions and any hesitation about screenings are rendered faithfully.",
            "Results conversations must be both precise and complete, especially when follow-up is needed. Worked example: a clinician explains, 'your Pap came back abnormal, which is common and usually not cancer, but we need to do a colposcopy to look more closely — let's schedule it'; the interpreter renders the result, the reassurance, the recommended follow-up procedure, and the plan to schedule it completely and accurately, so the patient understands both that this is manageable and that the follow-up is important.",
          ],
          terminology: [
            { term: "Pap smear", definition: "A screening test for cervical cancer and precancerous changes." },
            { term: "HPV testing", definition: "A test for the human papillomavirus, linked to cervical cancer." },
            { term: "Mammogram", definition: "An X-ray screening for breast cancer." },
            { term: "Colposcopy", definition: "A closer examination of the cervix after an abnormal Pap result." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When explaining an abnormal Pap result and recommended follow-up, the interpreter should:",
              options: ["Only mention it's abnormal", "Render the result, reassurance, and follow-up plan completely and accurately", "Skip the follow-up", "Reassure without the details"],
              answer: 1,
            },
          ],
        },
      ...
      lessons: [
        {
          ...
          videoUrl: V.c,
          objectives: [
            "Recognize common OB/GYN procedures and their vocabulary",
            "Interpret procedure explanations and consent accurately",
            "Convey instructions and after-care faithfully",
          ],
          content: [
            "OB/GYN involves a wide range of procedures, and the interpreter must know their names and be able to render the explanations around them. Common examples include the Pap smear and pelvic exam, ultrasound, colposcopy and cervical biopsy, dilation and curettage (D&C), hysteroscopy and laparoscopy, cesarean section, hysterectomy (removal of the uterus), tubal ligation, and IUD insertion or removal. Each carries a specific meaning, and the interpreter conveys both the procedure and the clinician's explanation completely.",
            "Procedure communication includes the purpose, what the patient will experience, risks and benefits, alternatives, and after-care, often as part of informed consent. The interpreter renders every element faithfully, because consent is only valid when the patient truly understands what is proposed. Instructions before and after a procedure — preparation, activity restrictions, warning signs to watch for — are conveyed precisely so the patient can follow them safely.",
            "Because many OB/GYN procedures are intimate or carry significant consequences (such as affecting future fertility), accuracy is especially important. Worked example: before a tubal ligation the clinician explains that it is intended to be permanent and reviews the risks and alternatives; the interpreter renders the permanence, the risks, the alternatives, and the consent request exactly and completely, so the patient's decision is genuinely informed — never abbreviating a detail that could change a life-altering choice.",
          ],
          terminology: [
            { term: "D&C", definition: "Dilation and curettage — a procedure to remove tissue from the uterus." },
            { term: "Hysterectomy", definition: "Surgical removal of the uterus." },
            { term: "Laparoscopy", definition: "Minimally invasive surgery using a small camera through tiny incisions." },
            { term: "Tubal ligation", definition: "A procedure that blocks the fallopian tubes for permanent contraception." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When consenting to a procedure that affects future fertility, the explanation should be:",
              options: ["Abbreviated to save time", "Rendered exactly and completely, including permanence and alternatives", "Summarized", "Left to the patient to research"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Recognize common OB/GYN conditions and their vocabulary",
            "Interpret diagnoses and symptom descriptions precisely",
            "Convey serious diagnoses faithfully and with appropriate tone",
          ],
          content: [
            "The interpreter encounters many gynecologic and obstetric conditions and must know their vocabulary in both languages. Common gynecologic conditions include endometriosis, uterine fibroids, ovarian cysts, polycystic ovary syndrome (PCOS), pelvic inflammatory disease (PID), and gynecologic cancers (cervical, ovarian, uterine). Obstetric conditions include gestational diabetes, preeclampsia, ectopic pregnancy, miscarriage, and placenta previa. Each has a precise meaning that the interpreter renders accurately rather than approximating.",
            "Conveying a diagnosis requires both accuracy and appropriate tone. The interpreter renders the name of the condition, the clinician's explanation of what it means, and the plan, completely and faithfully, preserving how serious or reassuring the clinician's framing is. Symptom descriptions that point to these conditions — pelvic pain, abnormal bleeding, missed periods — are conveyed exactly, since they guide the diagnosis and the interpreter's precision supports getting it right.",
            "Some diagnoses are frightening or carry loss, and the interpreter conveys them with fidelity and care. Worked example: a clinician gently explains, 'the ultrasound shows the pregnancy is in the fallopian tube — this is an ectopic pregnancy, it can't continue safely, and we need to treat it to protect your health'; the interpreter renders the diagnosis, its meaning, and the recommended treatment completely and with the clinician's compassionate tone, neither blunting the seriousness nor adding the interpreter's own words to a deeply emotional moment.",
          ],
          terminology: [
            { term: "Endometriosis", definition: "A condition where uterine-like tissue grows outside the uterus, causing pain." },
            { term: "Fibroids", definition: "Noncancerous growths of the uterus." },
            { term: "Ectopic pregnancy", definition: "A pregnancy implanted outside the uterus, often in a fallopian tube." },
            { term: "PCOS", definition: "Polycystic ovary syndrome, a hormonal disorder affecting ovulation." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When a clinician delivers a serious diagnosis with a compassionate tone, the interpreter should:",
              options: ["Blunt the seriousness", "Render the diagnosis, meaning, and plan faithfully, preserving the tone", "Add their own comfort", "Summarize the news"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Recognize common OB/GYN medications and their vocabulary",
            "Interpret drug names, doses, and instructions precisely",
            "Convey pregnancy-safety and warning information faithfully",
          ],
          content: [
            "OB/GYN uses distinctive medications the interpreter must handle with precision. These include prenatal vitamins and folic acid, hormonal medications (contraceptives, hormone therapy for menopause), fertility drugs, medications used in labor (such as oxytocin to induce or strengthen contractions, and pain-relief options), Rh immune globulin (RhoGAM) for Rh-negative patients, antibiotics for infections, and treatments for gynecologic conditions. Drug names, doses, routes, and schedules are conveyed exactly, as in all medical interpreting.",
            "Medication communication includes why a drug is prescribed, how and when to take it, side effects, and warnings, all rendered completely so the patient can use the medication safely. Pregnancy and breastfeeding add a critical dimension: whether a medication is safe during pregnancy or lactation is essential information, and the interpreter conveys any such guidance precisely, since a misunderstanding could affect both patient and baby.",
            "Instructions and warnings around these medications are safety-critical and must be exact. Worked example: a clinician says, 'because you're Rh-negative, we're giving you a RhoGAM injection now to protect future pregnancies, and I want you to stop this other medication because it isn't safe in pregnancy'; the interpreter renders the reason for the injection and, especially, the instruction to stop the unsafe medication completely and precisely, because both directly affect the safety of the patient and the pregnancy.",
          ],
          terminology: [
            { term: "Oxytocin", definition: "A medication used to induce or strengthen labor contractions." },
            { term: "RhoGAM", definition: "Rh immune globulin given to Rh-negative patients to protect future pregnancies." },
            { term: "Folic acid", definition: "A supplement taken before and during pregnancy to prevent birth defects." },
            { term: "Hormone therapy", definition: "Medication using hormones, e.g., for contraception or menopause symptoms." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "An instruction to stop a medication that isn't safe in pregnancy should be:",
              options: ["Rendered completely and precisely", "Softened", "Left out", "Deferred to a later visit"],
              answer: 0,
            },
          ],
        },
  ...
  finalAssessment: {
    title: "Obstetrics & Gynecology Interpreting — Final Exam",
    category: "Medical",
    durationMinutes: 60,
    passingScore: 80,
    questions: [
      { id: "q1", question: "Obstetrics is the branch of medicine that cares for:", options: ["Only newborns", "Pregnancy, childbirth, and the period just after", "The digestive system", "Bone health"], answer: 1 },
      { id: "q2", question: "'Gestation' refers to:", options: ["The number of births", "The length of a pregnancy in weeks", "A type of scan", "A medication"], answer: 1 },
      { id: "q3", question: "'Gravida' and 'para' describe:", options: ["Blood pressure and pulse", "The number of pregnancies and the number of births", "Two medications", "Two trimesters"], answer: 1 },
      { id: "q4", question: "'LMP' is used to:", options: ["Measure blood sugar", "Estimate the due date", "Name a vaccine", "Describe a procedure"], answer: 1 },
      { id: "q5", question: "When a patient gives her LMP and prior pregnancy history, the interpreter should:", options: ["Approximate the dates", "Render the dates and history exactly", "Summarize", "Skip a miscarriage"], answer: 1 },
      { id: "q6", question: "Prenatal care is best described as:", options: ["Care after birth", "Ongoing care during pregnancy to monitor mother and baby", "Emergency surgery", "A single visit"], answer: 1 },
      { id: "q7", question: "'Fundal height' is:", options: ["A blood test", "A measurement of the uterus tracking fetal growth", "A medication dose", "A heart rate"], answer: 1 },
      { id: "q8", question: "'Preeclampsia' is:", options: ["A normal part of labor", "A pregnancy complication with high blood pressure and warning signs", "A vaccine", "A screening test"], answer: 1 },
      { id: "q9", question: "Warning-sign instructions (severe headache, vision changes, sudden swelling) should be:", options: ["Softened", "Rendered completely and precisely, with urgency", "Summarized", "Omitted"], answer: 1 },
      { id: "q10", question: "'Ultrasound' uses:", options: ["Radiation", "Sound waves to view the fetus", "A blood sample", "An incision"], answer: 1 },
      { id: "q11", question: "Labor and delivery is characterized by:", options: ["A slow, unhurried pace", "A fast, emotionally intense pace with time-sensitive decisions", "No communication", "Only written instructions"], answer: 1 },
      { id: "q12", question: "'Dilation' and 'effacement' describe the:", options: ["Opening and thinning of the cervix", "Heart rate of the baby", "Level of pain", "Type of anesthesia"], answer: 0 },
      { id: "q13", question: "A 'cesarean section' is:", options: ["A vaginal birth", "Surgical delivery through the abdomen", "A prenatal test", "A pain medication"], answer: 1 },
      { id: "q14", question: "An 'epidural' is:", options: ["A type of contraction", "Regional anesthesia for pain relief in labor", "A screening test", "A surgical delivery"], answer: 1 },
      { id: "q15", question: "When an urgent C-section is recommended and consent requested, the interpreter should:", options: ["Explain the surgery themselves", "Render the situation, recommendation, and consent request immediately and precisely", "Reassure the patient", "Decide for the patient"], answer: 1 },
      { id: "q16", question: "The 'postpartum' period is:", options: ["Before pregnancy", "The time after childbirth as the body recovers", "The first trimester", "Labor"], answer: 1 },
      { id: "q17", question: "'Lochia' refers to:", options: ["Normal bleeding and discharge after delivery", "A contraction", "A screening test", "A medication"], answer: 0 },
      { id: "q18", question: "'Lactation' is:", options: ["Uterine recovery", "The production of breast milk and breastfeeding support", "A prenatal test", "A surgical procedure"], answer: 1 },
      { id: "q19", question: "A postpartum patient's disclosure of persistent crying should be:", options: ["Softened", "Rendered precisely, as it can signal postpartum depression", "Omitted", "Ignored"], answer: 1 },
      { id: "q20", question: "Heavy bleeding described as 'soaking a pad every hour' should be:", options: ["Downplayed", "Rendered exactly as a warning sign", "Summarized", "Left out"], answer: 1 },
      { id: "q21", question: "Gynecology focuses on:", options: ["The female reproductive system outside of pregnancy", "Only pregnancy", "The heart", "Newborn care"], answer: 0 },
      { id: "q22", question: "'Dysmenorrhea' means:", options: ["Absent periods", "Painful menstrual periods", "Heavy bleeding", "Menopause"], answer: 1 },
      { id: "q23", question: "'Menopause' is:", options: ["The start of periods", "The natural end of menstrual cycles", "A pregnancy stage", "A contraceptive"], answer: 1 },
      { id: "q24", question: "When a patient frankly describes intimate gynecologic symptoms, the interpreter should:", options: ["Soften or censor", "Render everything faithfully in the patient's register", "Add reassurance", "Summarize"], answer: 1 },
      { id: "q25", question: "Reproductive health includes:", options: ["Only cancer screening", "Contraception, family planning, fertility, and STIs", "Only labor", "Bone density"], answer: 1 },
      { id: "q26", question: "An 'IUD' is:", options: ["A prenatal vitamin", "A long-acting contraceptive placed in the uterus", "A screening test", "A labor medication"], answer: 1 },
      { id: "q27", question: "When a patient's beliefs shape her contraceptive choices, the interpreter should:", options: ["Advise the best method", "Render her values and questions completely and neutrally", "Skip the beliefs", "Persuade her"], answer: 1 },
      { id: "q28", question: "'STI' stands for:", options: ["A surgical technique", "A sexually transmitted infection", "A screening interval", "A medication"], answer: 1 },
      { id: "q29", question: "Preventive gynecologic care aims to:", options: ["Treat only existing disease", "Detect problems early, before symptoms", "Replace all other care", "Avoid screenings"], answer: 1 },
      { id: "q30", question: "A 'Pap smear' screens for:", options: ["Breast cancer", "Cervical cancer and precancerous changes", "Diabetes", "Anemia"], answer: 1 },
      { id: "q31", question: "A 'mammogram' is:", options: ["A pelvic exam", "An X-ray screening for breast cancer", "A blood test", "A bone scan"], answer: 1 },
      { id: "q32", question: "A 'colposcopy' is done:", options: ["Before pregnancy always", "As a closer exam of the cervix after an abnormal Pap", "To measure blood pressure", "To induce labor"], answer: 1 },
      { id: "q33", question: "When explaining an abnormal Pap and follow-up, the interpreter should:", options: ["Only say it's abnormal", "Render the result, reassurance, and follow-up plan completely", "Skip the follow-up", "Reassure without details"], answer: 1 },
      { id: "q34", question: "A 'D&C' is a procedure to:", options: ["Screen for cancer", "Remove tissue from the uterus", "Deliver a baby", "Measure the cervix"], answer: 1 },
      { id: "q35", question: "A 'hysterectomy' is:", options: ["Removal of the uterus", "A prenatal scan", "A contraceptive pill", "A labor technique"], answer: 0 },
      { id: "q36", question: "'Laparoscopy' is:", options: ["An open surgery", "Minimally invasive surgery using a small camera", "A blood test", "A vaccine"], answer: 1 },
      { id: "q37", question: "When consenting to a procedure affecting future fertility, the explanation should be:", options: ["Abbreviated", "Rendered exactly and completely, including permanence and alternatives", "Summarized", "Left to the patient"], answer: 1 },
      { id: "q38", question: "'Endometriosis' is:", options: ["A pregnancy complication", "Uterine-like tissue growing outside the uterus, causing pain", "A contraceptive", "A screening test"], answer: 1 },
      { id: "q39", question: "'Fibroids' are:", options: ["Cancerous tumors always", "Noncancerous growths of the uterus", "A hormone", "A type of scan"], answer: 1 },
      { id: "q40", question: "An 'ectopic pregnancy' is:", options: ["A normal pregnancy", "A pregnancy implanted outside the uterus", "A twin pregnancy", "A postpartum condition"], answer: 1 },
      { id: "q41", question: "'PCOS' is:", options: ["A surgical procedure", "A hormonal disorder affecting ovulation", "A contraceptive device", "A screening test"], answer: 1 },
      { id: "q42", question: "When a clinician delivers a serious diagnosis compassionately, the interpreter should:", options: ["Blunt the seriousness", "Render the diagnosis, meaning, and plan faithfully, preserving the tone", "Add their own comfort", "Summarize"], answer: 1 },
      { id: "q43", question: "'Oxytocin' is used to:", options: ["Prevent pregnancy", "Induce or strengthen labor contractions", "Screen for cancer", "Treat menopause"], answer: 1 },
      { id: "q44", question: "'RhoGAM' is given to:", options: ["All pregnant patients", "Rh-negative patients to protect future pregnancies", "Induce labor", "Treat infection"], answer: 1 },
      { id: "q45", question: "'Folic acid' is taken to:", options: ["Relieve labor pain", "Help prevent birth defects before and during pregnancy", "Stop bleeding", "Treat fibroids"], answer: 1 },
      { id: "q46", question: "Whether a medication is safe in pregnancy or breastfeeding is:", options: ["Unimportant", "Essential information the interpreter conveys precisely", "For the pharmacist only", "Optional"], answer: 1 },
      { id: "q47", question: "An instruction to stop a medication that isn't safe in pregnancy should be:", options: ["Rendered completely and precisely", "Softened", "Left out", "Deferred"], answer: 0 },
      { id: "q48", question: "Drug names, doses, and schedules should be interpreted:", options: ["Approximately", "Exactly", "Only if asked", "In summary"], answer: 1 },
      { id: "q49", question: "In intimate OB/GYN encounters, the interpreter should maintain:", options: ["Personal commentary", "Professionalism, dignity, and faithful rendering", "Their own opinions", "Selective interpreting"], answer: 1 },
      { id: "q50", question: "Throughout OB/GYN encounters, the interpreter's core stance is:", options: ["Advising on choices", "Accurate, neutral rendering while staying in role", "Making decisions", "Persuading the patient"], answer: 1 },
    ],
  },
}
