...
// ─────────────────────────────────────────────────────────────────────────
// 16. Oncology Interpreting
// ────────────────────────────────────────────────���────────────────────────
cchiContent["oncology-interpreting"] = {
  resources: res("CONI"),
  modules: [
    {
      id: "m1",
      ...
      lessons: [
        {
          ...
          videoUrl: V.a,
          objectives: [
            "Define oncology and explain what cancer is",
            "Recognize core cancer vocabulary in both languages",
            "Interpret basic cancer explanations accurately and sensitively",
          ],
          content: [
            "Oncology is the branch of medicine devoted to the diagnosis and treatment of cancer. At its most basic, cancer is a disease in which the body's own cells grow and divide uncontrollably, forming abnormal cells that can invade nearby tissue and, in many cases, spread to other parts of the body. The interpreter must be fluent in the foundational vocabulary — cancer, malignant, benign, tumor, cell, tissue, and metastasis — because these words appear in almost every oncology conversation and each carries a precise meaning that changes what the patient understands.",
            "A crucial early distinction is between benign and malignant. A benign growth is not cancer and does not spread; a malignant growth is cancer and can invade and spread. Confusing these two words could lead a patient to believe they do or do not have cancer, so the interpreter renders them exactly and never blends them into a vaguer phrase. Similarly, the concept of metastasis — cancer spreading from where it started to another part of the body — is central to how serious a cancer is, and the interpreter conveys it precisely.",
            "Cancer conversations are almost always emotionally heavy, and the interpreter combines precision with sensitivity while staying strictly in role. Worked example: an oncologist explains, 'the biopsy shows this growth is malignant, which means it is cancer, but the good news is we don't see any sign that it has spread'; the interpreter renders 'malignant,' the plain-language 'it is cancer,' and the reassurance that there is no sign of spread completely and exactly — neither softening the diagnosis nor dropping the reassurance — so the patient receives the true, full message.",
          ],
          terminology: [
            { term: "Oncology", definition: "The branch of medicine dealing with the diagnosis and treatment of cancer." },
            { term: "Malignant", definition: "Cancerous; able to invade tissue and spread." },
            { term: "Benign", definition: "Not cancerous; does not spread." },
            { term: "Metastasis", definition: "The spread of cancer from its original site to another part of the body." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "Confusing 'benign' and 'malignant' matters because:",
              options: ["They mean the same thing", "One means not cancer and the other means cancer — the error changes the diagnosis", "Neither relates to cancer", "They are only used in surgery"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Explain what a tumor is and how types differ",
            "Recognize vocabulary for tumor types and locations",
            "Interpret tumor descriptions with precision",
          ],
          content: [
            "A tumor is an abnormal mass of tissue that forms when cells grow more than they should. Not all tumors are cancer: tumors may be benign (not cancerous), malignant (cancerous), or sometimes premalignant (with the potential to become cancer). The interpreter must render these distinctions exactly, along with descriptions of a tumor's size, location, and behavior, because these details shape the diagnosis and the treatment plan.",
            "Cancers and tumors are often named for the tissue or cell type where they begin, and this vocabulary recurs constantly: carcinoma (from epithelial tissue, the most common), sarcoma (from bone or soft tissue), leukemia (of the blood), lymphoma (of the lymphatic system). Clinicians also describe a 'primary' tumor (where cancer started) versus a 'secondary' or 'metastatic' tumor (where it has spread). The interpreter conveys these terms precisely, since they identify what kind of cancer is being discussed.",
            "Tumor descriptions frequently include exact measurements and locations that the interpreter must preserve. Worked example: a radiologist reports, 'there is a two-centimeter tumor in the upper lobe of the right lung, and it appears to be the primary site with no other masses seen'; the interpreter renders the size, the precise location, and the fact that it appears to be the primary tumor completely and exactly, because these specifics determine staging and treatment and cannot be approximated or summarized.",
          ],
          terminology: [
            { term: "Tumor", definition: "An abnormal mass of tissue formed by excessive cell growth." },
            { term: "Carcinoma", definition: "Cancer that begins in epithelial tissue (skin or organ linings)." },
            { term: "Primary tumor", definition: "The original site where a cancer began." },
            { term: "Metastatic tumor", definition: "A tumor formed by cancer that has spread from its primary site." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "A tumor described as the 'primary' site means:",
              options: ["Where the cancer spread to", "Where the cancer originally began", "A benign growth", "A blood cancer"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Explain what cancer staging is and why it matters",
            "Recognize staging vocabulary, including the TNM system",
            "Interpret stage information precisely without approximating",
          ],
          content: [
            "Cancer staging describes how much cancer is in the body and how far it has spread. Staging guides treatment decisions and gives a sense of prognosis, so it is one of the most consequential pieces of information in oncology. The most common framework is the TNM system: T describes the size and extent of the primary tumor, N whether it has reached nearby lymph nodes, and M whether it has metastasized to distant sites. These are often summarized as an overall stage, typically 0 through IV.",
            "Because staging is expressed in exact terms — a stage number, a TNM combination, the number of lymph nodes involved — the interpreter must render every figure and letter precisely. The difference between 'stage II' and 'stage IV,' or between 'no lymph nodes involved' and 'three lymph nodes involved,' fundamentally changes the patient's situation and treatment, and an approximation could seriously mislead the patient. The interpreter also conveys the clinician's explanation of what the stage means completely.",
            "Staging conversations combine hard numbers with profound implications, and the interpreter handles both faithfully. Worked example: an oncologist says, 'this is a stage II breast cancer — the tumor is about three centimeters and one lymph node is involved, but it has not spread to distant organs'; the interpreter renders the exact stage, the tumor size, the one involved lymph node, and the absence of distant spread completely and precisely, so the patient understands their true situation and can engage in decisions about treatment.",
          ],
          terminology: [
            { term: "Staging", definition: "Describing how much cancer is in the body and how far it has spread." },
            { term: "TNM system", definition: "A staging system based on Tumor size, lymph Nodes, and Metastasis." },
            { term: "Lymph nodes", definition: "Small structures cancer can spread to first; key to staging." },
            { term: "Prognosis", definition: "The likely course or outcome of a disease." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When interpreting a cancer stage and TNM details, the interpreter should:",
              options: ["Round to a general range", "Render every figure and letter precisely", "Give only the stage number", "Skip the lymph node count"],
              answer: 1,
            },
          ],
        },
      ...
      lessons: [
        {
          ...
          videoUrl: V.b,
          objectives: [
            "Explain what chemotherapy is and how it is given",
            "Recognize chemotherapy vocabulary and side-effect terms",
            "Interpret treatment instructions and warnings precisely",
          ],
          content: [
            "Chemotherapy uses powerful drugs to kill cancer cells or stop them from dividing. Because these drugs travel through the bloodstream, chemotherapy is a systemic treatment that reaches cancer throughout the body. It may be given intravenously or by mouth, in cycles that alternate treatment with recovery periods. The interpreter must know this vocabulary — chemotherapy, cycle, infusion, IV, oral — and render the schedule and route precisely, because following the regimen correctly is essential to its effectiveness and safety.",
            "Chemotherapy has well-known side effects that clinicians explain in detail: nausea and vomiting, hair loss, fatigue, and a lowered blood count that raises infection risk (neutropenia). The interpreter conveys each side effect, the instructions for managing it, and especially the warning signs that require urgent attention. Because chemotherapy weakens the immune system, instructions about fever and infection are safety-critical, and the interpreter renders them with their full urgency.",
            "Precision about warning signs can be life-saving. Worked example: an oncology nurse instructs, 'while you're on chemo, if your temperature reaches 100.4 degrees or higher, call us immediately or go to the ER — an infection can become dangerous very fast when your counts are low'; the interpreter renders the exact temperature threshold and the instruction to seek care immediately completely and precisely, because a delayed response to fever during chemotherapy can be life-threatening.",
          ],
          terminology: [
            { term: "Chemotherapy", definition: "Drug treatment that kills cancer cells or stops them from dividing." },
            { term: "Systemic treatment", definition: "Treatment that reaches the whole body through the bloodstream." },
            { term: "Cycle", definition: "A period of chemotherapy treatment followed by a recovery period." },
            { term: "Neutropenia", definition: "A low white-blood-cell count that raises infection risk." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "A chemotherapy fever-threshold instruction (e.g., 100.4°F) should be:",
              options: ["Rounded", "Rendered with the exact threshold and urgency", "Omitted", "Summarized as 'watch for fever'"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Explain what radiation therapy is and how it is delivered",
            "Recognize radiation vocabulary and side-effect terms",
            "Interpret radiation instructions and schedules accurately",
          ],
          content: [
            "Radiation therapy uses high-energy rays to damage and destroy cancer cells in a specific area. Unlike chemotherapy, radiation is usually a local treatment aimed precisely at the tumor. It is most often delivered externally by a machine (external beam radiation) over a series of daily sessions across several weeks, though it can also be delivered internally (brachytherapy). The interpreter renders this vocabulary and the treatment schedule precisely, since radiation depends on consistent, correctly timed sessions.",
            "Radiation has side effects that are often local to the treated area — skin changes like redness or irritation, fatigue, and effects specific to the region being treated. Clinicians give careful instructions about skin care, activity, and what to expect, and the interpreter conveys these completely so the patient can care for themselves through treatment. The precise area treated and the number and timing of sessions are conveyed exactly.",
            "Because radiation is precisely targeted and scheduled, accuracy about the plan matters. Worked example: a radiation oncologist explains, 'you'll come in every weekday for six weeks for a short treatment, and it's important not to miss sessions; wash the treated skin gently with water only and don't apply any lotions before treatment'; the interpreter renders the schedule, the importance of not missing sessions, and each specific skin-care instruction completely and precisely, because both adherence and skin protection affect the treatment's success and the patient's comfort.",
          ],
          terminology: [
            { term: "Radiation therapy", definition: "Treatment using high-energy rays to destroy cancer cells." },
            { term: "Local treatment", definition: "Treatment aimed at a specific area rather than the whole body." },
            { term: "External beam radiation", definition: "Radiation delivered from a machine outside the body." },
            { term: "Brachytherapy", definition: "Internal radiation delivered from a source placed inside the body." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "Radiation therapy is usually described as a:",
              options: ["Systemic treatment reaching the whole body", "Local treatment aimed at a specific area", "Type of chemotherapy", "Surgical procedure"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Explain what immunotherapy is and how it works",
            "Recognize immunotherapy vocabulary and side-effect terms",
            "Interpret novel-treatment explanations accurately",
          ],
          content: [
            "Immunotherapy is a newer category of cancer treatment that helps the patient's own immune system recognize and attack cancer cells. Rather than directly poisoning cancer cells like chemotherapy, it works by boosting or redirecting the immune response. Common types include checkpoint inhibitors, monoclonal antibodies, and CAR T-cell therapy. The interpreter should recognize these terms and, when a clinician explains the concept in plain language, render that explanation faithfully so the patient understands how their treatment is different.",
            "Immunotherapy has a distinctive side-effect profile: because it activates the immune system, it can cause immune-related reactions where the body's defenses attack healthy tissue, affecting the skin, gut, lungs, or hormone-producing glands. Clinicians explain what symptoms to watch for and stress reporting them early. The interpreter conveys these explanations and warnings completely, since immune-related side effects can become serious and are managed differently from chemotherapy side effects.",
            "Because immunotherapy is complex and evolving, clear rendering of the clinician's explanation is especially important. Worked example: an oncologist says, 'this medicine helps your immune system fight the cancer, but because it revs up your immune system it can sometimes cause it to attack normal organs — so if you get a new bad diarrhea, cough, or rash, tell us right away rather than waiting'; the interpreter renders the mechanism in the clinician's plain terms and each specific warning symptom completely, so the patient understands both how the treatment works and when to seek help.",
          ],
          terminology: [
            { term: "Immunotherapy", definition: "Treatment that helps the immune system recognize and attack cancer." },
            { term: "Checkpoint inhibitor", definition: "A drug that releases the immune system's brakes to fight cancer." },
            { term: "Monoclonal antibody", definition: "A lab-made antibody that targets specific cancer cells." },
            { term: "Immune-related side effect", definition: "A reaction where the activated immune system attacks healthy tissue." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "Immunotherapy works primarily by:",
              options: ["Directly poisoning all fast-growing cells", "Helping the patient's own immune system attack cancer", "Using high-energy rays", "Removing the tumor surgically"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Explain the role of surgery in cancer treatment",
            "Recognize surgical oncology vocabulary",
            "Interpret surgical explanations and consent precisely",
          ],
          content: [
            "Surgery is one of the oldest and most common cancer treatments, used to remove tumors and, in some cases, nearby tissue or lymph nodes. It may be curative (aiming to remove all the cancer), diagnostic (a biopsy to obtain tissue), or palliative (to relieve symptoms). The interpreter must know surgical vocabulary — resection, biopsy, margins, lymph node dissection, and the names of specific operations (such as mastectomy or lobectomy) — and render them precisely.",
            "Surgical communication centers on informed consent: the clinician explains the operation, its purpose, risks and benefits, alternatives, and what recovery involves. The interpreter renders every element completely, because valid consent requires the patient to genuinely understand what is planned. Concepts like 'clear margins' (no cancer at the edges of removed tissue) and how much tissue will be removed are conveyed exactly, since they carry real meaning for the patient's outcome.",
            "Cancer surgery often has life-altering consequences, so precision is essential. Worked example: a surgeon explains, 'we'll remove the tumor along with a margin of healthy tissue and check the nearby lymph nodes; there is a risk of bleeding and infection, and recovery will take several weeks'; the interpreter renders the extent of the surgery, the check of the lymph nodes, each stated risk, and the recovery expectation completely and exactly, so the patient's consent is truly informed and nothing that could affect their decision is lost.",
          ],
          terminology: [
            { term: "Resection", definition: "Surgical removal of a tumor or part of an organ." },
            { term: "Margins", definition: "The edges of removed tissue, checked for the presence of cancer cells." },
            { term: "Biopsy", definition: "Removal of a tissue sample to diagnose cancer." },
            { term: "Lymph node dissection", definition: "Surgical removal of lymph nodes to check for or treat spread." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "'Clear margins' after cancer surgery means:",
              options: ["The tumor was left in place", "No cancer cells were found at the edges of the removed tissue", "The surgery was cancelled", "The cancer had spread widely"],
              answer: 1,
            },
          ],
        },
    ...
    {
      id: "m3",
      title: "Oncology Terminology",
      lessons: [
        {
          id: "l1",
          title: "Cancer Vocabulary",
          duration: "13:00",
          type: "video",
          completed: false,
          videoUrl: V.c,
          objectives: [
            "Build a broad oncology vocabulary in both languages",
            "Distinguish easily confused cancer terms",
            "Interpret cancer terminology accurately and consistently",
          ],
          content: [
            "Accurate oncology interpreting rests on a broad, precise vocabulary. Beyond the basics, the interpreter must know terms such as oncologist, remission (a decrease or disappearance of cancer signs), recurrence (cancer returning), relapse, prognosis, and words describing tumor behavior like invasive, in situ, and grade (how abnormal the cells look). Each of these has a specific meaning, and using the correct equivalent in the other language is essential to conveying the true message.",
            "Some oncology terms are easily confused and must be distinguished carefully. 'Remission' is not the same as 'cure'; 'grade' (how abnormal cells look) is different from 'stage' (how far cancer has spread); 'recurrence' means the cancer came back. The interpreter renders each of these exactly rather than substituting a near-synonym, because the difference can dramatically change what the patient believes about their situation and their future.",
            "Consistency and precision protect the patient's understanding across a long treatment journey. Worked example: an oncologist says, 'the scan shows you're in remission, which means we don't see active cancer right now, but it's not the same as a cure, so we'll keep monitoring you closely'; the interpreter renders 'remission,' the plain-language meaning, and the important clarification that it is not a cure completely and exactly, so the patient neither over-interprets the good news nor misses the ongoing need for follow-up.",
          ],
          terminology: [
            { term: "Remission", definition: "A decrease in or disappearance of signs of cancer — not the same as a cure." },
            { term: "Recurrence", definition: "The return of cancer after a period of improvement." },
            { term: "Grade", definition: "How abnormal cancer cells look under a microscope (different from stage)." },
            { term: "In situ", definition: "Cancer that remains in its original site and has not invaded nearby tissue." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "'Remission' should be interpreted as:",
              options: ["The same as a cure", "A decrease or disappearance of cancer signs — distinct from a cure", "Cancer spreading", "A type of surgery"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Recognize the procedures used to diagnose and monitor cancer",
            "Interpret procedure explanations and instructions accurately",
            "Convey results faithfully, including their significance",
          ],
          content: [
            "Diagnosing and monitoring cancer relies on a range of procedures the interpreter encounters constantly. These include imaging studies (CT, MRI, PET scans, ultrasound, mammogram, X-ray), the biopsy (the definitive way to diagnose cancer by examining tissue), blood tests including tumor markers, and specialized tests like bone marrow biopsy or endoscopy. The interpreter renders the names of these procedures and the instructions around them precisely, since preparation and correct performance affect the results.",
            "Procedure communication includes explaining the purpose, what the patient will experience, any preparation, and the results. The interpreter conveys each element completely, and takes special care with results, which carry great weight in oncology. Terms like 'positive' and 'negative,' 'tumor markers,' and specific values or findings are rendered exactly, along with the clinician's interpretation, because a misconveyed result could cause needless fear or false reassurance.",
            "Results conversations require both precision and sensitivity. Worked example: an oncologist explains, 'the PET scan didn't show any new areas of cancer and your tumor marker went down, which are both good signs that the treatment is working'; the interpreter renders the specific findings — no new areas on the PET scan, the lower tumor marker — and the clinician's interpretation that the treatment appears to be working, completely and exactly, so the patient understands both the concrete results and what they mean.",
          ],
          terminology: [
            { term: "Biopsy", definition: "The examination of tissue to definitively diagnose cancer." },
            { term: "PET scan", definition: "An imaging test that shows metabolic activity, used to detect cancer." },
            { term: "Tumor marker", definition: "A substance measured in blood that can indicate cancer activity." },
            { term: "Imaging study", definition: "A scan such as CT, MRI, or ultrasound used to view the body." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "The definitive procedure to diagnose cancer is usually:",
              options: ["A blood pressure check", "A biopsy examining tissue", "A temperature reading", "A physical exam only"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Understand how oncology treatment plans are structured",
            "Recognize treatment-plan vocabulary and combined approaches",
            "Interpret complex, multi-part plans completely and clearly",
          ],
          content: [
            "An oncology treatment plan is the roadmap of how a patient's cancer will be treated, often combining several methods in sequence. The interpreter encounters vocabulary describing how treatments relate to one another: neoadjuvant therapy (given before the main treatment, often to shrink a tumor), adjuvant therapy (given after, to reduce recurrence risk), first-line and second-line treatment, and the idea of a multidisciplinary plan involving several specialists. These terms describe the strategy and must be rendered precisely.",
            "Treatment plans are frequently complex and multi-part, and the interpreter's job is to convey every step completely and in order, without simplifying the plan into something the patient will misunderstand. The sequence, timing, and purpose of each element — surgery, then chemotherapy, then radiation, for example — are all clinically meaningful, and the interpreter renders them exactly so the patient can follow and consent to the whole plan.",
            "Because plans guide months of care and major decisions, accuracy across the full plan is essential. Worked example: an oncologist lays out, 'the plan is chemotherapy first to shrink the tumor, then surgery to remove it, and then radiation afterward to lower the chance it comes back'; the interpreter renders each phase, its order, and its purpose — shrink, remove, then reduce recurrence — completely and precisely, so the patient understands the entire course of treatment rather than just one piece of it.",
          ],
          terminology: [
            { term: "Treatment plan", definition: "The overall roadmap of how a patient's cancer will be treated." },
            { term: "Neoadjuvant therapy", definition: "Treatment given before the main treatment, often to shrink a tumor." },
            { term: "Adjuvant therapy", definition: "Treatment given after the main treatment to reduce recurrence risk." },
            { term: "Multidisciplinary care", definition: "A plan involving several specialists working together." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When interpreting a multi-part treatment plan, the interpreter should:",
              options: ["Simplify it to one step", "Convey every step, its order, and its purpose completely", "Give only the first treatment", "Skip the sequence"],
              answer: 1,
            },
          ],
        },
      ...
      lessons: [
        {
          ...
          objectives: [
            ...
            "Recognize palliative-care vocabulary",
            "Interpret goals-of-care and symptom discussions faithfully",
          ],
          content: [
            "Palliative care focuses on relieving the symptoms, pain, and stress of a serious illness and improving quality of life, and it can be provided at any stage of cancer — alongside curative treatment, not only at the end of life. This is a common and important distinction the interpreter must preserve: palliative care is not the same as giving up or as hospice. The interpreter renders the clinician's explanation of what palliative care is faithfully, because patients and families often misunderstand the term.",
            "Palliative-care conversations address symptom management (pain, nausea, breathlessness, fatigue), emotional and spiritual support, and 'goals of care' — what matters most to the patient and how treatment should reflect that. The interpreter conveys these discussions completely and with their full emotional weight, including the patient's own values and wishes, which are central to the conversation and must be rendered exactly as the patient expresses them.",
            "These conversations are sensitive and values-laden, and the interpreter renders them without steering. Worked example: a palliative-care physician says, 'our goal is to keep you as comfortable and active as possible while you continue treatment — tell me what's most important to you right now'; the interpreter renders the clarification that palliative care accompanies ongoing treatment and the open invitation for the patient to state what matters most, completely and faithfully, so the patient's own priorities can shape the plan without the interpreter influencing them.",
          ],
          terminology: [
            { term: "Palliative care", definition: "Care focused on relieving symptoms and improving quality of life at any stage." },
            { term: "Goals of care", definition: "What matters most to the patient, guiding treatment decisions." },
            { term: "Symptom management", definition: "Treating pain, nausea, and other symptoms to improve comfort." },
            { term: "Quality of life", definition: "The patient's overall comfort and well-being." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "A key point about palliative care the interpreter must preserve is that it:",
              options: ["Means giving up on treatment", "Can be provided at any stage, alongside curative treatment", "Is only for the last days of life", "Is the same as hospice"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Define hospice care and when it is used",
            "Recognize hospice vocabulary",
            "Interpret end-of-life discussions with fidelity and compassion",
          ],
          content: [
            "Hospice care is a specific kind of care for patients near the end of life, typically when curative treatment is no longer pursued and the focus is entirely on comfort and dignity in the time remaining. It usually involves a team supporting the patient and family, often at home, and addresses physical comfort, emotional and spiritual needs, and support for loved ones. The interpreter must render the meaning of hospice accurately, since it represents a profound shift in the goals of care.",
            "Hospice conversations are among the most emotionally difficult in medicine, and the interpreter conveys them with complete fidelity and appropriate compassion while staying in role. Terms like comfort care, do-not-resuscitate (DNR) orders, and prognosis in terms of time are rendered exactly, because families make significant decisions based on them. The interpreter preserves the clinician's gentle, honest tone and the patient's and family's responses without softening the reality or adding their own words.",
            "In these moments, faithful rendering honors both truth and dignity. Worked example: a physician gently tells a family, 'we've reached the point where treatment is no longer helping, and I'd recommend hospice so we can focus on keeping her comfortable and at peace'; the interpreter renders the honest message that treatment is no longer helping and the recommendation for hospice completely and with the physician's compassionate tone, neither blunting the difficult truth nor inserting false hope, so the family can understand and respond to what is truly being said.",
          ],
          terminology: [
            { term: "Hospice care", definition: "End-of-life care focused entirely on comfort and dignity." },
            { term: "Comfort care", definition: "Care aimed at relieving suffering rather than curing disease." },
            { term: "DNR order", definition: "A do-not-resuscitate order declining CPR if the heart stops." },
            { term: "Prognosis", definition: "The expected course of the illness, sometimes expressed as time remaining." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When interpreting a difficult hospice recommendation, the interpreter should:",
              options: ["Add false hope to soften it", "Render the honest message and compassionate tone completely, without blunting it", "Summarize the news", "Give the family advice"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Recognize ethical issues that arise in oncology and end-of-life care",
            "Understand the interpreter's ethical duties in these situations",
            "Maintain accuracy, impartiality, and role boundaries under pressure",
          ],
          content: [
            "End-of-life oncology raises profound ethical issues: truth-telling and how much a patient wishes to know, advance directives and who makes decisions when a patient cannot, disagreements between the patient, family, and team, and cultural or religious beliefs about death and disclosure. The interpreter frequently finds themselves at the center of these emotionally and ethically charged conversations, and their duty is to render everything faithfully and impartially, not to resolve the ethical questions.",
            "The interpreter's professional ethics — accuracy, completeness, impartiality, confidentiality, and staying within the interpreter role — are tested most sharply here. Families may ask the interpreter to withhold a diagnosis, to soften bad news, or to advise them; a patient may confide something painful. The interpreter renders all messages faithfully and does not omit, alter, or filter information, even when asked, while transparently voicing any genuine communication difficulty to the whole group rather than acting on their own.",
            "Handling these situations with integrity protects everyone involved. Worked example: before an appointment a family member quietly asks the interpreter, 'please don't tell my mother it's terminal — in our culture we don't say that'; the interpreter does not simply agree or refuse, but transparently raises this with the clinician so the care team can address the family's wishes appropriately, because deciding what the patient is told is a clinical and ethical matter for the team, and the interpreter's role remains faithful, complete, and impartial rendering — never selectively withholding the truth.",
          ],
          terminology: [
            { term: "Advance directive", definition: "A document stating a patient's wishes for care if they cannot decide." },
            { term: "Truth-telling", definition: "The ethical question of how and how much a patient is told about their illness." },
            { term: "Impartiality", definition: "The interpreter's duty to remain neutral and not take sides." },
            { term: "Transparency", definition: "Openly voicing a communication issue to all parties rather than acting privately." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "If a family asks the interpreter to withhold a terminal diagnosis, the interpreter should:",
              options: ["Quietly agree and omit it", "Transparently raise it with the clinician and keep rendering faithfully", "Refuse and lecture the family", "Decide themselves what to tell the patient"],
              answer: 1,
            },
          ],
        },
  ...
  finalAssessment: {
    title: "Oncology Interpreting — Final Exam",
    category: "Medical",
    durationMinutes: 60,
    passingScore: 80,
    questions: [
      { id: "q1", question: "Oncology is the branch of medicine dealing with:", options: ["Heart disease", "The diagnosis and treatment of cancer", "Bone fractures", "Pregnancy"], answer: 1 },
      { id: "q2", question: "Cancer is fundamentally a disease of:", options: ["Bacteria", "Cells growing and dividing uncontrollably", "Blood pressure", "Nutrition"], answer: 1 },
      { id: "q3", question: "'Benign' means:", options: ["Cancerous and spreading", "Not cancerous and does not spread", "Metastatic", "Terminal"], answer: 1 },
      { id: "q4", question: "'Malignant' means:", options: ["Not cancer", "Cancerous, able to invade and spread", "A benign growth", "A blood test"], answer: 1 },
      { id: "q5", question: "'Metastasis' refers to:", options: ["A benign tumor", "Cancer spreading from its original site to another part of the body", "A cure", "A type of scan"], answer: 1 },
      { id: "q6", question: "Confusing 'benign' and 'malignant' matters because:", options: ["They are synonyms", "One means not cancer and the other means cancer", "Neither relates to cancer", "They only apply to surgery"], answer: 1 },
      { id: "q7", question: "A 'tumor' is:", options: ["Always cancerous", "An abnormal mass of tissue from excessive cell growth", "A blood cell", "A type of scan"], answer: 1 },
      { id: "q8", question: "A 'primary tumor' is:", options: ["Where the cancer spread to", "Where the cancer originally began", "A benign cyst", "A lymph node"], answer: 1 },
      { id: "q9", question: "'Carcinoma' is cancer that begins in:", options: ["Bone", "Epithelial tissue (skin or organ linings)", "Blood", "Lymph nodes"], answer: 1 },
      { id: "q10", question: "Cancer staging describes:", options: ["The patient's age", "How much cancer is in the body and how far it has spread", "The cost of treatment", "The hospital's rating"], answer: 1 },
      { id: "q11", question: "In the TNM system, the 'N' stands for:", options: ["Nutrition", "Nearby lymph Nodes", "New tumor", "Nursing"], answer: 1 },
      { id: "q12", question: "When interpreting a cancer stage and TNM details, the interpreter should:", options: ["Round to a general range", "Render every figure and letter precisely", "Give only the stage number", "Skip the node count"], answer: 1 },
      { id: "q13", question: "Chemotherapy is described as a:", options: ["Local treatment", "Systemic treatment reaching the whole body via the bloodstream", "Surgical procedure", "Imaging study"], answer: 1 },
      { id: "q14", question: "Chemotherapy is often given in:", options: ["A single dose only", "Cycles of treatment followed by recovery periods", "One surgery", "One scan"], answer: 1 },
      { id: "q15", question: "'Neutropenia' means:", options: ["High blood pressure", "A low white-blood-cell count raising infection risk", "A tumor marker", "A type of scan"], answer: 1 },
      { id: "q16", question: "A chemotherapy fever-threshold instruction (e.g., 100.4°F) should be:", options: ["Rounded", "Rendered with the exact threshold and urgency", "Omitted", "Summarized loosely"], answer: 1 },
      { id: "q17", question: "Radiation therapy uses:", options: ["Drugs in the bloodstream", "High-energy rays to destroy cancer cells", "Surgery", "Antibodies"], answer: 1 },
      { id: "q18", question: "Radiation therapy is usually a:", options: ["Systemic treatment", "Local treatment aimed at a specific area", "Blood test", "Vaccine"], answer: 1 },
      { id: "q19", question: "'External beam radiation' is:", options: ["Radiation from a source placed inside the body", "Radiation delivered from a machine outside the body", "A chemotherapy drug", "A biopsy"], answer: 1 },
      { id: "q20", question: "Radiation skin-care and schedule instructions should be:", options: ["Summarized", "Rendered completely and precisely", "Skipped", "Left to the patient to guess"], answer: 1 },
      { id: "q21", question: "Immunotherapy works by:", options: ["Directly poisoning all cells", "Helping the patient's own immune system attack cancer", "Using high-energy rays", "Removing the tumor"], answer: 1 },
      { id: "q22", question: "A 'checkpoint inhibitor' is:", options: ["A surgical tool", "A drug that releases the immune system's brakes to fight cancer", "A scan", "A tumor marker"], answer: 1 },
      { id: "q23", question: "A distinctive risk of immunotherapy is:", options: ["Immune-related side effects where the immune system attacks healthy tissue", "Broken bones", "High cholesterol", "Tooth decay"], answer: 0 },
      { id: "q24", question: "When a clinician explains immunotherapy warning symptoms, the interpreter should:", options: ["Summarize them", "Render the mechanism and each warning symptom completely", "Skip them", "Give reassurance instead"], answer: 1 },
      { id: "q25", question: "Cancer surgery may be curative, diagnostic, or:", options: ["Palliative (to relieve symptoms)", "Cosmetic only", "Optional always", "Systemic"], answer: 0 },
      { id: "q26", question: "'Clear margins' after surgery means:", options: ["The tumor was left in place", "No cancer cells at the edges of the removed tissue", "The surgery was cancelled", "The cancer spread widely"], answer: 1 },
      { id: "q27", question: "A 'biopsy' is:", options: ["Removal of a tissue sample to diagnose cancer", "A blood pressure check", "A radiation session", "A chemotherapy cycle"], answer: 0 },
      { id: "q28", question: "When interpreting surgical informed consent, the interpreter should:", options: ["Summarize the risks", "Render the operation, purpose, risks, benefits, and recovery completely", "Give only the benefits", "Skip alternatives"], answer: 1 },
      { id: "q29", question: "'Remission' should be interpreted as:", options: ["The same as a cure", "A decrease or disappearance of cancer signs — distinct from a cure", "Cancer spreading", "A surgery type"], answer: 1 },
      { id: "q30", question: "'Recurrence' means:", options: ["The first diagnosis", "The return of cancer after a period of improvement", "A cure", "A benign tumor"], answer: 1 },
      { id: "q31", question: "'Grade' (as opposed to stage) describes:", options: ["How far cancer has spread", "How abnormal the cancer cells look", "The patient's age", "The cost of care"], answer: 1 },
      { id: "q32", question: "The definitive procedure to diagnose cancer is usually:", options: ["A blood pressure check", "A biopsy examining tissue", "A temperature reading", "A physical exam only"], answer: 1 },
      { id: "q33", question: "A 'tumor marker' is:", options: ["A surgical incision", "A substance in blood that can indicate cancer activity", "A radiation dose", "A stage number"], answer: 1 },
      { id: "q34", question: "When conveying test results, the interpreter should render 'positive,' 'negative,' and values:", options: ["Approximately", "Exactly, with the clinician's interpretation", "Only if good news", "In summary"], answer: 1 },
      { id: "q35", question: "An oncology 'treatment plan' is:", options: ["A single medication", "The overall roadmap of how the cancer will be treated", "A billing document", "A consent form only"], answer: 1 },
      { id: "q36", question: "'Neoadjuvant therapy' is given:", options: ["After the main treatment", "Before the main treatment, often to shrink a tumor", "Only in hospice", "Instead of surgery always"], answer: 1 },
      { id: "q37", question: "'Adjuvant therapy' is given:", options: ["Before the main treatment", "After the main treatment to reduce recurrence risk", "Only for benign tumors", "Never with surgery"], answer: 1 },
      { id: "q38", question: "When interpreting a multi-part treatment plan, the interpreter should:", options: ["Simplify to one step", "Convey every step, its order, and purpose completely", "Give only the first treatment", "Skip the sequence"], answer: 1 },
      { id: "q39", question: "Palliative care can be provided:", options: ["Only in the last days of life", "At any stage, alongside curative treatment", "Only after hospice", "Only in surgery"], answer: 1 },
      { id: "q40", question: "'Goals of care' refers to:", options: ["The hospital's budget", "What matters most to the patient, guiding treatment", "The interpreter's schedule", "A type of scan"], answer: 1 },
      { id: "q41", question: "A key point the interpreter must preserve about palliative care is that it:", options: ["Means giving up", "Is not the same as hospice and can accompany treatment", "Is only spiritual", "Replaces all medicine"], answer: 1 },
      { id: "q42", question: "Hospice care focuses on:", options: ["Aggressive curative treatment", "Comfort and dignity near the end of life", "Surgery only", "Diagnostic testing"], answer: 1 },
      { id: "q43", question: "A 'DNR order' is:", options: ["A chemotherapy drug", "A do-not-resuscitate order declining CPR", "A radiation plan", "A tumor grade"], answer: 1 },
      { id: "q44", question: "When interpreting a difficult hospice recommendation, the interpreter should:", options: ["Add false hope", "Render the honest message and compassionate tone completely", "Summarize the news", "Advise the family"], answer: 1 },
      { id: "q45", question: "An 'advance directive' is:", options: ["A treatment schedule", "A document stating a patient's wishes if they cannot decide", "A tumor marker", "A billing form"], answer: 1 },
      { id: "q46", question: "If a family asks the interpreter to withhold a terminal diagnosis, the interpreter should:", options: ["Quietly agree and omit it", "Transparently raise it with the clinician and keep rendering faithfully", "Refuse and lecture the family", "Decide what to tell the patient"], answer: 1 },
      { id: "q47", question: "In ethically charged end-of-life conversations, the interpreter's duty is to:", options: ["Resolve the ethical questions", "Render everything faithfully and impartially, staying in role", "Take the family's side", "Make the decisions"], answer: 1 },
      { id: "q48", question: "If asked to soften bad news, the interpreter should:", options: ["Soften it as asked", "Render all messages faithfully without omitting or altering", "Refuse to interpret", "Add their own comfort"], answer: 1 },
      { id: "q49", question: "Cancer conversations require the interpreter to combine:", options: ["Speed and casualness", "Precision with sensitivity while staying in role", "Personal opinions with advice", "Selective interpreting"], answer: 1 },
      { id: "q50", question: "Throughout oncology encounters, the interpreter's core stance is:", options: ["Advising on treatment", "Accurate, complete, impartial rendering while staying in role", "Making decisions", "Comforting instead of interpreting"], answer: 1 },
    ],
  },
}

// ─────────────────────────────────────────────────────────────────────────
// 17. CCHI Exam Preparation Master Course (capstone)
// ─────────────────────────────────────────────────────────────────────────
cchiContent["cchi-exam-preparation-master-course"] = {
  resources: res("CEPM"),
  modules: [
    {
      id: "m1",
      title: "CCHI Exam Overview",
      lessons: [
        {
          id: "l1",
          ...
          videoUrl: V.a,
          objectives: [
            "Describe the CCHI credentials and the two-exam pathway",
            "Explain eligibility and the overall exam format",
            "Build a realistic study and test-day plan",
          ],
          content: [
            "The Certification Commission for Healthcare Interpreters (CCHI) offers a certification pathway built around two exams. The first is the CoreCHI written exam, a computer-based multiple-choice test open to interpreters of any language. Passing it earns the CoreCHI credential. The second is the CHI oral performance exam, currently available for specific languages (such as Spanish, Arabic, and Mandarin), which tests actual interpreting skill and, when passed together with the written exam, earns the full CHI credential. Understanding this two-part structure is the foundation of a good study plan.",
            "Eligibility requires meeting CCHI's education and training prerequisites — a minimum age, a high school diploma or equivalent, at least 40 hours of healthcare interpreter training, and documented language proficiency. Candidates apply, are approved for an eligibility window, and then schedule their exam(s) at a testing center or through remote proctoring. Knowing these requirements early prevents last-minute surprises and lets you focus your preparation time on the content itself.",
            "This master course is organized to mirror what the exams actually assess: ethics and standards of practice, medical knowledge (terminology and anatomy), legal and regulatory knowledge such as HIPAA, and interpreting performance. Worked approach: a strong candidate maps their study calendar to these domains, spends the most time on their weakest areas identified through practice questions, and simulates real test conditions with the mock exams before test day — a plan this course is built to support step by step.",
          ],
          terminology: [
            { term: "CCHI", definition: "The Certification Commission for Healthcare Interpreters." },
            { term: "CoreCHI", definition: "The written, multiple-choice exam open to interpreters of any language." },
            { term: "CHI", definition: "The full credential earned by passing both the written and oral exams." },
            { term: "Eligibility window", definition: "The approved time period in which a candidate may schedule and take an exam." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "The CoreCHI exam is:",
              options: ["An oral performance exam for specific languages", "A written multiple-choice exam open to interpreters of any language", "An eligibility application", "A training course"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Describe the content domains of the CoreCHI written exam",
            "Recognize the question format and scoring approach",
            "Apply strategies for multiple-choice reasoning",
          ],
          content: [
            "The CoreCHI written exam is a multiple-choice test that assesses the knowledge underlying competent healthcare interpreting. Its content spans several domains: managing the interpreting encounter, healthcare terminology, the interpreter's role and ethics, cultural responsiveness, and interpreting as a profession (including legal and regulatory knowledge). The questions are scenario-based as often as they are factual, asking not just what a term means but what an interpreter should do in a realistic situation.",
            "Because so many questions are scenario-based, success depends on applying principles rather than memorizing facts alone. A typical item describes a moment in an encounter and asks for the best action; the strongest answer is almost always the one that keeps the interpreter accurate, complete, impartial, and within role, and that promotes direct communication between provider and patient. Recognizing this pattern lets you reason toward the intended answer even when a question is unfamiliar.",
            "Effective test strategy combines content mastery with disciplined technique: read the full stem, identify what is actually being asked, eliminate answers that violate ethics or role, and choose the option that best serves accurate communication. Worked example: a question asks what to do when you realize you made an interpreting error moments ago; applying the standards, the best answer is to correct the error openly and immediately rather than ignoring it or fixing it silently — a reasoning pattern this course reinforces throughout.",
          ],
          terminology: [
            { term: "Content domain", definition: "A major knowledge area the exam draws questions from." },
            { term: "Scenario-based question", definition: "An item describing a situation and asking for the best interpreter action." },
            { term: "Stem", definition: "The part of a multiple-choice item that poses the question." },
            { term: "Distractor", definition: "An incorrect answer option designed to look plausible." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "On scenario-based written questions, the best answer usually:",
              options: ["Has the interpreter give advice", "Keeps the interpreter accurate, impartial, and within role", "Skips difficult content", "Sides with the provider"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Describe the structure of the CHI oral performance exam",
            "Recognize the interpreting modes it tests",
            "Apply performance strategies for accuracy and completeness",
          ],
          content: [
            "The CHI oral performance exam tests actual interpreting ability through recorded scenarios. It typically assesses the three core modes: consecutive interpreting (the most heavily weighted, reflecting real encounters), simultaneous interpreting, and sight translation of a short document. Candidates hear or read source material and produce their interpretation, which is scored on accuracy, completeness, and delivery. Because it measures skill rather than recall, preparation means practicing interpreting itself, not just studying.",
            "Scoring focuses on how faithfully the message is transferred: whether meaning is conveyed accurately and completely, whether register and tone are preserved, whether numbers and terminology are handled correctly, and whether the delivery is clear and professional. Common point losses come from omissions, additions, distortions, and unmanaged memory load in consecutive mode. Strong candidates use note-taking, request repetition or clarification appropriately, and manage the flow without editing the message.",
            "Performance improves with deliberate, realistic practice. Worked example: in a consecutive segment a patient gives a long, emotional answer full of specific details — three medications, two dates, and a strong feeling; the high-scoring interpreter uses brief notes to capture the specifics, renders every detail and the emotional register accurately, and manages the turn length by signaling to pause when needed — exactly the skills the oral mock exam in this course lets you rehearse.",
          ],
          terminology: [
            { term: "Consecutive interpreting", definition: "Interpreting after the speaker pauses; the most weighted oral mode." },
            { term: "Simultaneous interpreting", definition: "Interpreting in real time as the speaker continues." },
            { term: "Sight translation", definition: "Reading a written document aloud in the other language." },
            { term: "Register", definition: "The level and style of language, preserved in the interpretation." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "The most heavily weighted mode on the CHI oral exam is typically:",
              options: ["Sight translation", "Simultaneous interpreting", "Consecutive interpreting", "Written translation"],
              answer: 2,
            },
          ],
        },
      ...
      lessons: [
        {
          ...
          videoUrl: V.b,
          objectives: [
            "Review the core principles of the healthcare interpreter Code of Ethics",
            "Apply the principles to exam scenarios",
            "Distinguish ethics (what is right) from standards (how to do it)",
          ],
          content: [
            "The Code of Ethics is the moral foundation of healthcare interpreting and a heavily tested area. Its core principles include confidentiality (keeping everything learned private), accuracy and completeness (rendering everything faithfully without adding, omitting, or altering), impartiality (staying neutral and avoiding conflicts of interest), respect for all parties, maintaining professional boundaries and role, cultural awareness, and continued professional development. The exam expects you to recognize these principles and apply them under pressure.",
            "A code of ethics states what is right; it answers 'what values must guide me?' On the exam, most ethics questions are scenarios where two considerations seem to compete, and the correct answer upholds the principles rather than the interpreter's personal impulse to help, fix, or advise. For example, the impulse to comfort a frightened patient is kind, but the ethical answer keeps the interpreter rendering faithfully and lets the provider provide the comfort.",
            "Applying the code consistently is the key skill. Worked example: a patient, after the appointment, asks the interpreter which specialist they should choose; the ethically correct response is to decline to advise and, if appropriate, offer to interpret the patient's question to the provider — honoring impartiality and role boundaries. Recognizing that the 'helpful' answer is often the wrong answer on ethics items is one of the most valuable exam insights.",
          ],
          terminology: [
            { term: "Confidentiality", definition: "Keeping all information learned during interpreting private." },
            { term: "Accuracy", definition: "Rendering the message faithfully without adding, omitting, or changing it." },
            { term: "Impartiality", definition: "Remaining neutral and avoiding conflicts of interest." },
            { term: "Role boundaries", definition: "The limits that keep the interpreter from advising or acting for others." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When a patient asks the interpreter for personal advice, the ethical response is to:",
              options: ["Give honest advice", "Decline and, if appropriate, interpret the question to the provider", "Choose for the patient", "Ignore the patient"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Review the Standards of Practice and how they operationalize ethics",
            "Recognize standard procedures for the interpreting encounter",
            "Apply standards to common exam scenarios",
          ],
          content: [
            "If the Code of Ethics is what is right, the Standards of Practice are how to do it — the concrete, expected behaviors that put the principles into action across an encounter. They cover the pre-session (introducing yourself and your role, positioning), managing the flow (using first person, managing turn-taking, requesting clarification), ensuring accuracy (correcting your own errors, asking for repetition), managing cultural and communication issues transparently, and closing the encounter appropriately. These procedures are frequently tested.",
            "The standards translate abstract values into recognizable actions. Impartiality becomes 'do not engage in private conversations that exclude a party'; accuracy becomes 'transparently ask for clarification rather than guessing.' On the exam, questions often describe a procedural moment — someone speaks too long, two people talk at once, an idiom won't translate — and ask for the standard-based action, which is almost always to intervene transparently, in role, so communication stays accurate and direct.",
            "Knowing the standard action for common situations is exam gold. Worked example: a provider uses an idiom or an acronym the patient won't understand; the standards-based response is for the interpreter to render it and, if needed, transparently ask the provider to clarify or explain, rather than silently 'fixing' it or explaining it themselves. This 'intervene transparently and stay in role' pattern answers a large share of standards questions.",
          ],
          terminology: [
            { term: "Standards of Practice", definition: "The expected behaviors that put the Code of Ethics into action." },
            { term: "Pre-session", definition: "A brief introduction of the interpreter's role before the encounter begins." },
            { term: "First person", definition: "Interpreting as 'I,' speaking as each party rather than 'he said.'" },
            { term: "Transparency", definition: "Making any interpreter intervention openly, to all parties." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "When a provider uses an idiom the patient won't understand, the standards-based action is to:",
              options: ["Explain it yourself", "Render it and transparently ask the provider to clarify if needed", "Skip it", "Whisper an explanation to the patient"],
              answer: 1,
            },
          ],
        },
        {
          ...
          completed: false,
          objectives: [
            "Review expectations for professional conduct and boundaries",
            "Recognize conflicts of interest and how to handle them",
            "Apply conduct principles to workplace and exam scenarios",
          ],
          content: [
            "Professional conduct covers how interpreters carry themselves as members of a profession: punctuality and reliability, appropriate appearance and demeanor, honesty about qualifications and limits, declining assignments beyond one's competence or where a conflict exists, ongoing professional development, and respectful collaboration with the care team. The exam tests whether you understand these expectations and can recognize when conduct falls short.",
            "Conflicts of interest and boundary issues are a special focus. An interpreter should not accept an assignment involving a family member or close acquaintance, should not accept gifts or favors that compromise impartiality, and should disclose anything that could bias the encounter. When an assignment exceeds their competence — an unfamiliar specialty, a mode they are not qualified for — the professional action is to say so and, if necessary, decline or seek a more qualified interpreter, because patient safety outweighs pride.",
            "Sound conduct means knowing and respecting your limits. Worked example: an interpreter is asked to interpret for their own cousin's serious diagnosis; the professionally correct response is to disclose the relationship and decline the assignment so an impartial interpreter can serve, protecting both the patient and the integrity of the encounter. Recognizing that declining can be the right professional choice is a recurring exam theme.",
          ],
          terminology: [
            { term: "Conflict of interest", definition: "A personal stake that could bias the interpreter's neutrality." },
            { term: "Scope of competence", definition: "The range of assignments an interpreter is qualified to handle." },
            { term: "Professional development", definition: "Ongoing training to maintain and improve skills." },
            { term: "Boundaries", definition: "The limits that keep the interpreter's role professional and impartial." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "Asked to interpret for a close family member's serious diagnosis, the interpreter should:",
              options: ["Accept to be helpful", "Disclose the relationship and decline so an impartial interpreter can serve", "Interpret only the good news", "Give the family advice"],
              answer: 1,
            },
          ],
        },
    ...
    },
    {
      ...
      lessons: [
        {
          id: "l1",
          title: "Comprehensive Terminology Review",
          duration: "15:00",
          type: "video",
          completed: false,
          videoUrl: V.c,
          objectives: [
            "Review the structure of medical terms and common word parts",
            "Recall high-yield terminology across body systems",
            "Apply terminology knowledge to exam and interpreting scenarios",
          ],
          content: [
            "Medical terminology is one of the most testable areas because it is precise and rule-based. Most medical terms are built from word parts: a root (the core meaning, such as cardi- for heart), a prefix (added to the front, such as hyper- for excessive), and a suffix (added to the end, such as -itis for inflammation). Decoding a term from its parts — 'pericarditis' as inflammation (-itis) around (peri-) the heart (cardi-) — lets you handle even unfamiliar words, a skill the exam rewards.",
            "A high-yield review spans the body systems and their common terms: cardiovascular (hypertension, myocardial infarction, arrhythmia), respiratory (dyspnea, bronchitis, pneumonia), gastrointestinal (gastritis, hepatitis, colonoscopy), musculoskeletal (fracture, arthritis, osteoporosis), neurological (stroke, seizure, neuropathy), endocrine (diabetes, hypothyroidism), and more. It also covers common abbreviations, symptoms versus signs, and the difference between a diagnosis and a procedure — all frequent exam and interpreting content.",
            "For the interpreter, terminology is only useful when rendered accurately and completely in both languages. Worked example: a provider says a patient has 'a history of an MI and now presents with dyspnea on exertion'; the interpreter must know that MI is a myocardial infarction (heart attack) and that dyspnea on exertion is shortness of breath with activity, and render both precisely — because an approximate rendering could obscure a serious cardiac picture. This decode-and-render discipline is the heart of terminology mastery.",
          ],
          terminology: [
            { term: "Root", definition: "The core part of a medical term carrying its basic meaning." },
            { term: "Prefix / suffix", definition: "Word parts added to the front / end that modify a root's meaning." },
            { term: "Myocardial infarction", definition: "A heart attack; death of heart muscle from blocked blood flow." },
            { term: "Dyspnea", definition: "Difficult or labored breathing; shortness of breath." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "Breaking 'pericarditis' into parts, it means:",
              options: ["Removal of the heart", "Inflammation around the heart", "A fast heart rate", "A heart medication"],
              answer: 1,
            },
          ],
        },
    ...
    },
    {
      ...
      lessons: [
        {
          id: "l1",
          title: "Comprehensive Anatomy Review",
          duration: "15:00",
          type: "video",
          completed: false,
          videoUrl: V.a,
          objectives: [
            "Review the major body systems and their key structures",
            "Connect anatomy to common conditions and terminology",
            "Apply anatomy knowledge to interpreting scenarios",
          ],
          content: [
            "A working knowledge of anatomy underpins both the exam and daily interpreting. The review covers the major body systems and their principal organs and structures: cardiovascular (heart, arteries, veins), respiratory (lungs, airways, diaphragm), digestive (stomach, intestines, liver, pancreas), nervous (brain, spinal cord, nerves), musculoskeletal (bones, joints, muscles), urinary (kidneys, bladder), endocrine (thyroid, pancreas, adrenal glands), and reproductive systems. Knowing where structures are and what they do makes clinical conversations comprehensible.",
            "Anatomy connects directly to terminology and conditions: understanding that the coronary arteries supply the heart clarifies why a blockage causes a heart attack; knowing the liver's role clarifies hepatitis; understanding the kidneys explains renal failure and dialysis. The review also covers directional and positional terms (anterior, posterior, superior, inferior, lateral, medial) that providers use constantly and that interpreters must render precisely.",
            "For interpreting, anatomical precision prevents dangerous errors. Worked example: a surgeon explains a procedure on 'the proximal end of the femur near the hip'; the interpreter must know the femur is the thigh bone and that 'proximal' means the end nearer the body's center (here, toward the hip), rendering the exact location so the patient understands where the surgery will occur. Mislocating an anatomical reference could seriously misinform consent.",
          ],
          terminology: [
            { term: "Coronary arteries", definition: "The vessels that supply blood to the heart muscle." },
            { term: "Femur", definition: "The thigh bone, the long bone of the upper leg." },
            { term: "Proximal / distal", definition: "Nearer to / farther from the center of the body." },
            { term: "Anterior / posterior", definition: "Toward the front / toward the back of the body." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "'Proximal' refers to the location that is:",
              options: ["Farther from the center of the body", "Nearer to the center of the body", "Toward the back", "On the left side"],
              answer: 1,
            },
          ],
        },
    ...
    },
    {
      ...
      lessons: [
        {
          id: "l1",
          title: "Comprehensive HIPAA Review",
          duration: "14:00",
          type: "video",
          completed: false,
          videoUrl: V.b,
          objectives: [
            "Review HIPAA and the meaning of protected health information",
            "Understand the interpreter's obligations under HIPAA",
            "Apply HIPAA rules to interpreting and exam scenarios",
          ],
          content: [
            "HIPAA — the Health Insurance Portability and Accountability Act — sets national standards for protecting patients' health information. Its Privacy Rule governs the use and disclosure of protected health information (PHI): any information that identifies a patient and relates to their health, care, or payment. Interpreters routinely handle PHI and are bound to protect it. The exam expects familiarity with what PHI is, the minimum-necessary principle, and when disclosure is and is not permitted.",
            "As people who hear the most sensitive details of a patient's care, interpreters have clear HIPAA obligations: keep all PHI confidential, access and share only what is necessary for the interpreting task, never discuss patients outside the encounter, secure any notes (and destroy them appropriately), and follow the facility's privacy policies. These duties reinforce the ethical principle of confidentiality with legal weight — a breach can carry real consequences.",
            "Applying HIPAA correctly is a common exam scenario. Worked example: after interpreting, another interpreter or a friend asks the interpreter about an interesting case they handled; the HIPAA-compliant response is to decline to share any patient information, because discussing identifiable PHI outside the care relationship is a violation regardless of curiosity or good intentions. Recognizing that confidentiality has no 'off the clock' is a key readiness point.",
          ],
          terminology: [
            { term: "HIPAA", definition: "The U.S. law setting standards for protecting patient health information." },
            { term: "PHI", definition: "Protected health information — identifiable data about a patient's health, care, or payment." },
            { term: "Privacy Rule", definition: "The HIPAA rule governing use and disclosure of PHI." },
            { term: "Minimum necessary", definition: "Using or sharing only the least PHI needed for the task." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "If a friend asks the interpreter about an interesting patient case, the HIPAA-compliant response is to:",
              options: ["Share the interesting details", "Decline to share any patient information", "Share it without names", "Ask the patient first later"],
              answer: 1,
            },
          ],
        },
    ...
    },
    {
      ...
      lessons: [
        {
          id: "l1",
          title: "500-Question Practice Bank",
          duration: "20:00",
          type: "lecture",
          completed: false,
          objectives: [
            "Understand how to use the 500-item practice bank effectively",
            "Read answer explanations to learn from every question",
            "Use performance analytics to target weak areas",
          ],
          content: [
            "This module provides a 500-question practice bank spanning every exam domain — ethics and standards, medical terminology, anatomy, HIPAA and legal knowledge, cultural responsiveness, and managing the encounter — in the same scenario-based style as the real written exam. The bank is designed for repeated, active practice: rather than reading passively, you answer questions, check your reasoning against the explanation, and return to the topics that trip you up. Active retrieval like this is one of the most effective ways to prepare.",
            "Every question includes a detailed explanation of why the correct answer is right and why the distractors are wrong. Reading the explanations — even for questions you got right — turns each item into a mini-lesson, reinforcing the underlying principle so you can apply it to a new scenario on exam day. Over 500 items, this builds the pattern recognition that lets you answer confidently under time pressure.",
            "Performance analytics tie the practice together by tracking your accuracy across domains and over time, so you can see exactly where you are strong and where you need more work. Worked approach: after a practice session the analytics show you are scoring well on terminology but weak on standards-of-practice scenarios; you then focus your next sessions on standards questions and re-test until your accuracy climbs — a targeted, data-driven loop that this course's practice bank and analytics are built to support.",
          ],
          terminology: [
            { term: "Practice bank", definition: "A large pool of exam-style questions for repeated practice." },
            { term: "Answer explanation", definition: "The rationale for the correct answer and why others are wrong." },
            { term: "Active retrieval", definition: "Learning by recalling answers rather than rereading material." },
            { term: "Performance analytics", definition: "Tracking of accuracy by domain and over time to target study." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "The most effective way to use the practice bank is to:",
              options: ["Read questions passively without answering", "Answer, review explanations, and use analytics to target weak areas", "Only take questions once", "Skip the explanations"],
              answer: 1,
            },
          ],
        },
    ...
    },
    {
      ...
      lessons: [
        {
          id: "l1",
          title: "Written Mock Exam",
          duration: "20:00",
          type: "lecture",
          completed: false,
          objectives: [
            "Simulate the CoreCHI written exam under realistic conditions",
            "Practice timing and multiple-choice strategy end to end",
            "Review results to finalize a study plan",
          ],
          content: [
            "The written mock exam simulates the CoreCHI experience end to end: a full-length set of scenario-based multiple-choice questions across all content domains, taken in one timed sitting. Its purpose is not just to test knowledge but to rehearse the conditions — pacing yourself, sustaining focus, and managing the mental stamina a real exam demands. Taking a full mock removes the surprise from test day and reveals how your knowledge holds up under time pressure.",
            "Approach the mock as you would the real thing: work in a quiet space, keep to the time limit, and resist looking anything up. Use the strategies from Module 1 — read each stem carefully, eliminate answers that violate ethics or role, and choose the option that best serves accurate, direct communication. Flag and move on when stuck rather than burning time. This disciplined run-through is often where candidates discover their true pace.",
            "The real value comes after, in the review. Worked approach: you finish the mock, score it, and analyze not just which questions you missed but why — a terminology gap, a misread stem, a standards principle you applied incorrectly. You then return to the relevant course modules and the practice bank to close those specific gaps, and, if time allows, take a second mock to confirm improvement before sitting the actual exam.",
          ],
          terminology: [
            { term: "Mock exam", definition: "A full-length practice test simulating real exam conditions." },
            { term: "Timed sitting", definition: "Completing the exam within the real time limit in one session." },
            { term: "Pacing", definition: "Managing time so all questions can be answered." },
            { term: "Post-exam review", definition: "Analyzing missed questions to target further study." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "The greatest value of a written mock exam comes from:",
              options: ["Simply getting a score", "Reviewing why each missed question was wrong and closing those gaps", "Taking it without a time limit", "Looking up answers while testing"],
              answer: 1,
            },
          ],
        },
        {
          id: "l2",
          title: "Oral Mock Exam",
          duration: "20:00",
          type: "lecture",
          completed: false,
          objectives: [
            "Simulate the CHI oral performance exam across its modes",
            "Practice consecutive, simultaneous, and sight-translation skills",
            "Self-assess accuracy, completeness, and delivery",
          ],
          content: [
            "The oral mock exam rehearses the CHI performance test by walking through its modes: consecutive interpreting of a realistic provider-patient dialogue, simultaneous interpreting of a segment, and sight translation of a short document such as discharge instructions. Recording yourself and working through timed scenarios builds the stamina, memory, and note-taking skills that the real oral exam demands and that cannot be learned by studying alone.",
            "Self-assessment against the scoring criteria is essential. After each recorded scenario, evaluate whether you conveyed the message accurately and completely, preserved register and tone, handled numbers and terminology correctly, and delivered clearly and professionally. Listen specifically for the common errors — omissions, additions, distortions, and false starts — and note where memory load caused you to drop details in consecutive mode. This honest review is how oral performance improves.",
            "Deliberate, repeated practice closes the gap to a passing performance. Worked approach: on a consecutive segment you notice you dropped one of three medications the patient listed; you practice note-taking specifically for enumerated details, redo the segment, and confirm you now capture all three — then move on to strengthening register and delivery. Cycling through record, assess, and refine across all three modes is exactly how this oral mock builds exam readiness.",
          ],
          terminology: [
            { term: "Self-assessment", definition: "Evaluating your own interpretation against scoring criteria." },
            { term: "Note-taking", definition: "Brief notes that capture details and support memory in consecutive mode." },
            { term: "Omission / addition / distortion", definition: "The main accuracy errors scored against on the oral exam." },
            { term: "Delivery", definition: "The clarity and professionalism of the spoken interpretation." },
          ],
          knowledgeCheck: [
            {
              id: "k1",
              question: "To improve consecutive interpreting of a list of details, a candidate should:",
              options: ["Guess at the details", "Practice note-taking, then re-do and confirm all details are captured", "Skip the numbers", "Summarize the list"],
              answer: 1,
            },
          ],
        },
  ...
  finalAssessment: {
    ...
    passingScore: 80,
    questions: [
      { id: "q1", question: "CCHI stands for:", options: ["Certified Clinical Health Interpreters", "The Certification Commission for Healthcare Interpreters", "Council for Cultural Health Instruction", "Center for Community Health Interpreting"], answer: 1 },
      { id: "q2", question: "The CoreCHI exam is:", options: ["An oral performance exam", "A written multiple-choice exam open to any language", "A training course", "An eligibility form"], answer: 1 },
      { id: "q3", question: "The full CHI credential is earned by:", options: ["Passing the written exam only", "Passing both the written and oral exams", "Attending 40 hours of training", "Applying for eligibility"], answer: 1 },
      { id: "q4", question: "A common eligibility requirement is at least:", options: ["4 hours of training", "40 hours of healthcare interpreter training", "400 hours of college", "No training"], answer: 1 },
      { id: "q5", question: "Many written-exam questions are:", options: ["Essay questions", "Scenario-based, asking for the best interpreter action", "True/false only", "Math problems"], answer: 1 },
      { id: "q6", question: "On a scenario question, the best answer usually:", options: ["Has the interpreter give advice", "Keeps the interpreter accurate, impartial, and within role", "Sides with the provider", "Skips the difficulty"], answer: 1 },
      { id: "q7", question: "The most heavily weighted mode on the oral exam is typically:", options: ["Sight translation", "Simultaneous", "Consecutive", "Written translation"], answer: 2 },
      { id: "q8", question: "Sight translation means:", options: ["Interpreting in real time", "Reading a written document aloud in the other language", "Taking notes", "Summarizing a document"], answer: 1 },
      { id: "q9", question: "Simultaneous interpreting is:", options: ["Interpreting after the speaker pauses", "Interpreting in real time as the speaker continues", "Reading aloud", "Written only"], answer: 1 },
      { id: "q10", question: "If you realize you made an interpreting error moments ago, you should:", options: ["Ignore it", "Correct it openly and immediately", "Fix it silently", "Wait until the end"], answer: 1 },
      { id: "q11", question: "A code of ethics primarily states:", options: ["How to do each procedure", "What values must guide the interpreter", "The exam schedule", "The fee structure"], answer: 1 },
      { id: "q12", question: "Confidentiality means:", options: ["Sharing cases with colleagues", "Keeping all information learned during interpreting private", "Reporting to family", "Posting anonymized stories"], answer: 1 },
      { id: "q13", question: "Accuracy and completeness require the interpreter to:", options: ["Summarize to save time", "Render everything faithfully without adding, omitting, or altering", "Improve the message", "Leave out emotional content"], answer: 1 },
      { id: "q14", question: "Impartiality means:", options: ["Taking the patient's side", "Remaining neutral and avoiding conflicts of interest", "Advising the provider", "Choosing the best option for the patient"], answer: 1 },
      { id: "q15", question: "When a patient asks the interpreter for personal medical advice, the interpreter should:", options: ["Give honest advice", "Decline and, if appropriate, interpret the question to the provider", "Choose for them", "Ignore the question"], answer: 1 },
      { id: "q16", question: "The Standards of Practice describe:", options: ["What values matter", "How to put the ethical principles into action", "The exam fee", "The anatomy of the heart"], answer: 1 },
      { id: "q17", question: "A pre-session is when the interpreter:", options: ["Diagnoses the patient", "Briefly introduces their role before the encounter", "Takes the exam", "Writes the notes"], answer: 1 },
      { id: "q18", question: "Interpreting in 'first person' means:", options: ["Saying 'he said' and 'she said'", "Speaking as each party, using 'I'", "Summarizing", "Adding commentary"], answer: 1 },
      { id: "q19", question: "When a provider uses an idiom the patient won't understand, the standards-based action is to:", options: ["Explain it yourself", "Render it and transparently ask the provider to clarify if needed", "Skip it", "Whisper to the patient"], answer: 1 },
      { id: "q20", question: "When two parties talk at once, the interpreter should:", options: ["Interpret only the louder one", "Transparently manage turn-taking so each is rendered", "Ignore one", "Summarize both"], answer: 1 },
      { id: "q21", question: "A conflict of interest is:", options: ["A scheduling issue", "A personal stake that could bias the interpreter's neutrality", "A medical term", "A type of exam"], answer: 1 },
      { id: "q22", question: "Asked to interpret for a close family member's serious diagnosis, the interpreter should:", options: ["Accept to be helpful", "Disclose the relationship and decline so an impartial interpreter can serve", "Interpret only good news", "Advise the family"], answer: 1 },
      { id: "q23", question: "When an assignment exceeds the interpreter's competence, they should:", options: ["Proceed anyway", "Say so and, if necessary, decline or seek a more qualified interpreter", "Guess", "Ask the patient to help"], answer: 1 },
      { id: "q24", question: "Accepting a gift that could compromise impartiality is:", options: ["Encouraged", "A boundary/conflict issue to avoid", "Required", "Irrelevant"], answer: 1 },
      { id: "q25", question: "Professional development refers to:", options: ["A one-time class", "Ongoing training to maintain and improve skills", "The exam fee", "A conflict of interest"], answer: 1 },
      { id: "q26", question: "Most medical terms are built from:", options: ["Random letters", "A root, and often a prefix and suffix", "Only abbreviations", "Numbers"], answer: 1 },
      { id: "q27", question: "The suffix '-itis' means:", options: ["Removal", "Inflammation", "Pain", "Enlargement"], answer: 1 },
      { id: "q28", question: "'Pericarditis' means:", options: ["Removal of the heart", "Inflammation around the heart", "A fast heartbeat", "A heart drug"], answer: 1 },
      { id: "q29", question: "'MI' (myocardial infarction) is:", options: ["A muscle strain", "A heart attack", "A lung infection", "A stroke"], answer: 1 },
      { id: "q30", question: "'Dyspnea' means:", options: ["Chest pain", "Difficult or labored breathing", "Dizziness", "Fever"], answer: 1 },
      { id: "q31", question: "The prefix 'hyper-' means:", options: ["Below normal", "Excessive or above normal", "Around", "After"], answer: 1 },
      { id: "q32", question: "'Hypertension' is:", options: ["Low blood pressure", "High blood pressure", "A heart attack", "A slow pulse"], answer: 1 },
      { id: "q33", question: "A 'colonoscopy' is a:", options: ["Diagnosis", "Procedure to examine the colon", "Medication", "Blood test"], answer: 1 },
      { id: "q34", question: "A symptom differs from a sign in that a symptom is:", options: ["Measured by the provider", "Experienced and reported by the patient", "Always visible", "A lab value"], answer: 1 },
      { id: "q35", question: "The coronary arteries supply blood to the:", options: ["Lungs", "Heart muscle", "Kidneys", "Brain"], answer: 1 },
      { id: "q36", question: "The femur is the:", options: ["Upper arm bone", "Thigh bone", "Collarbone", "Shin bone"], answer: 1 },
      { id: "q37", question: "'Proximal' means:", options: ["Farther from the center of the body", "Nearer to the center of the body", "Toward the back", "On the outer side"], answer: 1 },
      { id: "q38", question: "'Anterior' means toward the:", options: ["Back", "Front", "Head", "Feet"], answer: 1 },
      { id: "q39", question: "The liver is part of the:", options: ["Respiratory system", "Digestive system", "Urinary system", "Nervous system"], answer: 1 },
      { id: "q40", question: "The kidneys are part of the:", options: ["Endocrine system only", "Urinary system", "Respiratory system", "Skeletal system"], answer: 1 },
      { id: "q41", question: "The brain and spinal cord make up the:", options: ["Cardiovascular system", "Central nervous system", "Digestive system", "Endocrine system"], answer: 1 },
      { id: "q42", question: "The thyroid is part of the:", options: ["Endocrine system", "Muscular system", "Respiratory system", "Urinary system"], answer: 0 },
      { id: "q43", question: "HIPAA is primarily a law about:", options: ["Interpreter fees", "Protecting patients' health information", "Exam eligibility", "Hospital construction"], answer: 1 },
      { id: "q44", question: "'PHI' stands for:", options: ["Public Health Institute", "Protected Health Information", "Private Hospital Insurance", "Patient History Index"], answer: 1 },
      { id: "q45", question: "The HIPAA 'minimum necessary' principle means:", options: ["Share everything", "Use or share only the least PHI needed for the task", "Never share anything", "Share only with family"], answer: 1 },
      { id: "q46", question: "If a friend asks about an interesting patient case, the interpreter should:", options: ["Share the details", "Decline to share any patient information", "Share without names", "Ask permission later"], answer: 1 },
      { id: "q47", question: "Interpreter notes containing PHI should be:", options: ["Kept as souvenirs", "Secured and destroyed appropriately", "Posted online", "Shared with colleagues"], answer: 1 },
      { id: "q48", question: "Confidentiality for an interpreter applies:", options: ["Only during work hours", "At all times, including after the encounter", "Only in the hospital", "Only for famous patients"], answer: 1 },
      { id: "q49", question: "The most effective way to use the practice bank is to:", options: ["Read passively", "Answer, review explanations, and target weak areas with analytics", "Take it once", "Skip explanations"], answer: 1 },
      { id: "q50", question: "Answer explanations are valuable because they:", options: ["Give the score", "Turn each question into a mini-lesson on the principle", "Save time", "List the fees"], answer: 1 },
      { id: "q51", question: "Performance analytics help a candidate:", options: ["Pay the exam fee", "See strengths and weaknesses by domain to target study", "Skip weak areas", "Avoid practice"], answer: 1 },
      { id: "q52", question: "The greatest value of a written mock exam is:", options: ["Just a score", "Reviewing why missed questions were wrong and closing gaps", "Untimed practice", "Looking up answers"], answer: 1 },
      { id: "q53", question: "During a mock exam, when stuck on a question you should:", options: ["Stop the exam", "Flag it and move on to manage pacing", "Look up the answer", "Guess randomly and quit"], answer: 1 },
      { id: "q54", question: "The oral mock exam should be approached by:", options: ["Studying notes only", "Recording yourself across the modes and self-assessing", "Skipping consecutive", "Reading silently"], answer: 1 },
      { id: "q55", question: "The main accuracy errors scored on the oral exam are:", options: ["Speed and accent", "Omissions, additions, and distortions", "Volume and posture", "Handwriting"], answer: 1 },
      { id: "q56", question: "To improve consecutive interpreting of a list of details, a candidate should:", options: ["Guess", "Practice note-taking, then re-do and confirm all details", "Skip numbers", "Summarize"], answer: 1 },
      { id: "q57", question: "Note-taking in consecutive mode is used to:", options: ["Replace listening", "Capture details and support memory", "Translate word for word", "Impress the provider"], answer: 1 },
      { id: "q58", question: "When a patient's answer is emotionally charged, the interpreter should:", options: ["Neutralize the emotion", "Preserve the register and tone faithfully", "Summarize", "Add comfort"], answer: 1 },
      { id: "q59", question: "If the interpreter does not hear or understand a segment, they should:", options: ["Guess", "Transparently ask for repetition or clarification", "Skip it", "Make something up"], answer: 1 },
      { id: "q60", question: "Numbers, dates, and dosages should be interpreted:", options: ["Approximately", "Exactly", "Only if asked", "Rounded"], answer: 1 },
      { id: "q61", question: "When a provider speaks for a long time without pausing, the interpreter may:", options: ["Summarize heavily", "Transparently signal to pause so the message can be rendered accurately", "Interpret only the end", "Interrupt to give an opinion"], answer: 1 },
      { id: "q62", question: "A patient uses a cultural expression that won't translate directly. The interpreter should:", options: ["Omit it", "Render it and, if needed, transparently note the cultural meaning to all parties", "Replace it with their own belief", "Explain it privately to the provider"], answer: 1 },
      { id: "q63", question: "The interpreter's role regarding provider and patient is to:", options: ["Make decisions", "Facilitate direct communication between them", "Speak for the patient", "Advise the provider"], answer: 1 },
      { id: "q64", question: "Everything said in the encounter should be interpreted, including:", options: ["Only medical content", "Side comments and everything spoken, kept transparent", "Only the provider's words", "Only the patient's words"], answer: 1 },
      { id: "q65", question: "If asked to do a task outside interpreting (e.g., escort a patient), the interpreter should:", options: ["Always do it", "Recognize it may fall outside the interpreter role and act accordingly", "Refuse rudely", "Do it and bill extra"], answer: 1 },
      { id: "q66", question: "Cultural responsiveness for an interpreter means:", options: ["Imposing their own culture", "Being aware of and transparently bridging cultural differences without taking over", "Ignoring culture", "Deciding what's culturally right"], answer: 1 },
      { id: "q67", question: "A 'biopsy' is:", options: ["A blood pressure check", "Removal of tissue for diagnosis", "A vaccine", "An X-ray"], answer: 1 },
      { id: "q68", question: "'Benign' means:", options: ["Cancerous", "Not cancerous", "Fatal", "Contagious"], answer: 1 },
      { id: "q69", question: "'Malignant' means:", options: ["Harmless", "Cancerous and able to spread", "Benign", "Inflamed"], answer: 1 },
      { id: "q70", question: "The prefix 'hypo-' means:", options: ["Above normal", "Below normal", "Around", "Fast"], answer: 1 },
      { id: "q71", question: "'Tachycardia' means:", options: ["A slow heart rate", "A fast heart rate", "No heartbeat", "Chest pain"], answer: 1 },
      { id: "q72", question: "The suffix '-ectomy' means:", options: ["Inflammation", "Surgical removal", "Viewing", "Pain"], answer: 1 },
      { id: "q73", question: "'Gastritis' is inflammation of the:", options: ["Liver", "Stomach", "Kidney", "Lung"], answer: 1 },
      { id: "q74", question: "The lungs are part of the:", options: ["Digestive system", "Respiratory system", "Urinary system", "Nervous system"], answer: 1 },
      { id: "q75", question: "'Hepatitis' involves the:", options: ["Heart", "Liver", "Brain", "Bone"], answer: 1 },
      { id: "q76", question: "Informed consent requires the patient to:", options: ["Sign quickly", "Understand the purpose, risks, benefits, and alternatives", "Not be told risks", "Agree without explanation"], answer: 1 },
      { id: "q77", question: "During consent interpreting, the interpreter should render:", options: ["Only the benefits", "The entire explanation completely and accurately", "A summary", "Only what the patient asks"], answer: 1 },
      { id: "q78", question: "If a provider asks the interpreter's opinion on the patient's culture, the interpreter should:", options: ["Act as the cultural authority", "Provide brief, transparent cultural information if appropriate while staying in role", "Refuse to speak", "Make decisions for the provider"], answer: 1 },
      { id: "q79", question: "The best answer to most ethics questions upholds:", options: ["The interpreter's impulse to help", "The ethical principles even when helping seems kinder", "The provider's preference", "Whatever is fastest"], answer: 1 },
      { id: "q80", question: "When a patient discloses something the interpreter finds shocking, the interpreter should:", options: ["React visibly", "Render it faithfully and remain professional and neutral", "Omit it", "Lecture the patient"], answer: 1 },
      { id: "q81", question: "The interpreter should position themselves so that:", options: ["They are the center of attention", "Provider and patient can communicate directly", "They block the patient", "Only the provider sees them"], answer: 1 },
      { id: "q82", question: "'Anesthesia' refers to:", options: ["A type of surgery", "Medication that removes sensation or induces sleep for procedures", "A diagnosis", "A lab test"], answer: 1 },
      { id: "q83", question: "'Prognosis' means:", options: ["The diagnosis", "The likely course or outcome of a disease", "The treatment", "The symptom"], answer: 1 },
      { id: "q84", question: "'Chronic' describes a condition that is:", options: ["Sudden and short", "Long-lasting or persistent", "Contagious", "Curable in a day"], answer: 1 },
      { id: "q85", question: "'Acute' describes a condition that is:", options: ["Long-lasting", "Sudden and often severe or short-term", "Mild always", "Genetic"], answer: 1 },
      { id: "q86", question: "When interpreting a medication instruction, the interpreter must convey:", options: ["Only the drug name", "The drug, dose, route, frequency, and warnings exactly", "A general idea", "Only the frequency"], answer: 1 },
      { id: "q87", question: "If a family member wants to answer for the patient, the interpreter should:", options: ["Interpret only the family member", "Render what is said and let the provider manage who speaks", "Silence the family", "Decide who is right"], answer: 1 },
      { id: "q88", question: "A candidate's study plan should focus most on:", options: ["Topics they already know", "Their weakest areas identified through practice", "Only ethics", "Only terminology"], answer: 1 },
      { id: "q89", question: "The best way to reduce test-day anxiety is to:", options: ["Avoid practice", "Simulate real conditions with full mock exams beforehand", "Cram the night before", "Skip the mock"], answer: 1 },
      { id: "q90", question: "When a written question has two seemingly correct answers, choose the one that:", options: ["Is longest", "Best upholds accuracy, impartiality, and role", "Mentions the provider", "Is most detailed"], answer: 1 },
      { id: "q91", question: "'Stat' in a clinical order means:", options: ["Stationary", "Immediately / urgently", "Stop", "Standard"], answer: 1 },
      { id: "q92", question: "'NPO' means:", options: ["No problem observed", "Nothing by mouth", "New patient orientation", "Normal pulse"], answer: 1 },
      { id: "q93", question: "A 'referral' is:", options: ["A prescription", "Sending a patient to another provider or specialist", "A lab result", "A diagnosis"], answer: 1 },
      { id: "q94", question: "If the interpreter recognizes the patient personally, they should:", options: ["Say nothing", "Disclose the potential conflict of interest", "Interpret selectively", "Give the patient advice"], answer: 1 },
      { id: "q95", question: "The interpreter's handling of an error mid-encounter should be:", options: ["Hidden", "Transparent — corrected openly for all parties", "Blamed on the speaker", "Ignored"], answer: 1 },
      { id: "q96", question: "'Contraindication' means:", options: ["A recommended treatment", "A reason a treatment should not be used", "A side effect", "A diagnosis"], answer: 1 },
      { id: "q97", question: "The interpreter should keep the flow of communication:", options: ["Under their own control of content", "Accurate and complete while letting the parties lead the conversation", "As short as possible", "Focused only on the provider"], answer: 1 },
      { id: "q98", question: "Sight translation of discharge instructions requires:", options: ["Summarizing the document", "Rendering the written content accurately and completely aloud", "Adding advice", "Reading only headings"], answer: 1 },
      { id: "q99", question: "The passing standard for this readiness assessment is:", options: ["50%", "80%", "60%", "100%"], answer: 1 },
      { id: "q100", question: "Overall, the CCHI exams and this readiness assessment reward an interpreter who is:", options: ["Fast and opinionated", "Accurate, complete, impartial, ethical, and within role", "Helpful by advising", "Willing to bend the rules"], answer: 1 },
    ],
  },
}
